...
```
221.600 ms (0 allocations: 0 bytes)
```
...
```
264.103 ms (0 allocations: 0 bytes)
...
```
Benchmark of BracketingNonlinearSolve.Alefeld:
  339.753 ms (0 allocations: 0 bytes)
Mean absolute error: 1.1832913578315177e-30

Benchmark of BracketingNonlinearSolve.Bisection:
  71.839 ms (0 allocations: 0 bytes)
Mean absolute error: 3.4512664603419266e-29

Benchmark of BracketingNonlinearSolve.Brent:
  72.025 ms (0 allocations: 0 bytes)
Mean absolute error: 1.1832913578315177e-30

Benchmark of BracketingNonlinearSolve.Falsi:
  77.620 ms (0 allocations: 0 bytes)
Mean absolute error: 3.4512664603419266e-29

Benchmark of BracketingNonlinearSolve.ITP:
  132.119 ms (0 allocations: 0 bytes)
Mean absolute error: 1.1832913578315177e-30

Benchmark of BracketingNonlinearSolve.Muller:
  7.287 ms (0 allocations: 0 bytes)
Mean absolute error: 9.999998071250149e-16

Benchmark of BracketingNonlinearSolve.Ridder:
  89.648 ms (0 allocations: 0 bytes)
Mean absolute error: 1.1832913578315177e-30

Benchmark of BracketingNonlinearSolve.ModAB:
  39.453 ms (0 allocations: 0 bytes)
Mean absolute error: 1.1832913578315177e-30
```
...
Interval: (0.5, 5.5)
Parameter: 0.05
Roots.jl: 16.11 ms, Error: 1.87e-15
Alefeld (BNS): 12.25 ms, Error: 7.79e-15
Bisection (BNS): 5.08 ms, Error: 4.53e-12
Brent (BNS): 5.27 ms, Error: 5.55e-16
Falsi (BNS): 51.05 ms, Error: 2.79e-13
ITP (BNS): 5.99 ms, Error: 1.22e-15
Ridder (BNS): 6.38 ms, Error: 6.59e-16
ModAB (BNS): 4.54 ms, Error: 5.55e-16
Bisection (SNS): 5.29 ms, Error: 4.53e-12
Brent (SNS): 5.4 ms, Error: 5.55e-16
Falsi (SNS): 51.26 ms, Error: 2.79e-13
Ridders (SNS): 6.28 ms, Error: 6.59e-16
\n=== Testing: sin(x) - 0.5x ===
Interval: (-10.0, 10.0)
Parameter: 0.3
Roots.jl: 24.66 ms, Error: 5.55e-17
Alefeld (BNS): 29.16 ms, Error: 5.55e-17
Bisection (BNS): 10.05 ms, Error: 1.09e-13
Brent (BNS): 11.57 ms, Error: 1.86e-13
Falsi (BNS): 20.01 ms, Error: 9.63e-14
ITP (BNS): 8.27 ms, Error: 5.55e-17
Ridder (BNS): 7.69 ms, Error: 9.44e-16
ModAB (BNS): 6.12 ms, Error: 3.89e-16
Bisection (SNS): 9.92 ms, Error: 1.09e-13
Brent (SNS): 11.56 ms, Error: 1.86e-13
Falsi (SNS): 20.18 ms, Error: 9.63e-14
Ridders (SNS): 7.62 ms, Error: 9.44e-16
\n=== Testing: exp(x) - 1 - x - x²/2 ===
Interval: (-2.0, 2.0)
Parameter: 0.005
Roots.jl: 30.05 ms, Error: 5.12e-17
Alefeld (BNS): 61.11 ms, Error: 1.13e-17
Bisection (BNS): 10.07 ms, Error: 9.59e-15
Brent (BNS): 12.85 ms, Error: 7.64e-15
Falsi (BNS): 692.74 ms, Error: 2.98e-13
ITP (BNS): 111.95 ms, Error: 3.21e-17
Ridder (BNS): 8.14 ms, Error: 6.68e-17
ModAB (BNS): 6.26 ms, Error: 6.51e-17
\n=== Testing: x·sin(1/x) - 0.1 ===
Interval: (0.01, 1.0)
Parameter: 0.01
Roots.jl: 25.89 ms, Error: 8.67e-18
Alefeld (BNS): FAILED - DomainError(Inf, "sin(x) is only defined for finite
 x.")
Bisection (BNS): 10.24 ms, Error: 3.57e-13
Brent (BNS): 40.57 ms, Error: 5.34e-13
Falsi (BNS): 19.56 ms, Error: 5.3e-13
ITP (BNS): 7.47 ms, Error: 8.67e-18
Ridder (BNS): 6.97 ms, Error: 2.86e-16
ModAB (BNS): 6.83 ms, Error: 6.42e-17
Bisection (SNS): 10.26 ms, Error: 3.57e-13
Brent (SNS): 16.27 ms, Error: 5.34e-13
Falsi (SNS): 18.32 ms, Error: 5.3e-13
Ridders (SNS): 6.73 ms, Error: 2.86e-16
```
...
---------------------------------------------------------------------------
-------------------------------------------------------
Wilkinson-like polynomia 16.1ms         12.3ms         5.1ms          5.3ms
          51.0ms         6.0ms          6.4ms          4.5ms          5.3ms
          5.4ms          51.3ms         6.3ms          
sin(x) - 0.5x            24.7ms         29.2ms         10.1ms         11.6m
s         20.0ms         8.3ms          7.7ms          6.1ms          9.9ms
          11.6ms         20.2ms         7.6ms          
exp(x) - 1 - x - x²/     30.1ms         61.1ms         10.1ms         12.9m
s         692.7ms        112.0ms        8.1ms          6.3ms          9.2ms
          11.8ms         690.0ms        8.0ms          
1/(x-0.5) - 2            19.6ms         7.5ms          4.1ms          4.8ms
          104.4ms        6.5ms          4.3ms          3.1ms          4.1ms
          5.0ms          105.6ms        4.2ms          
log(x) - x + 2           32.5ms         35.7ms         10.5ms         9.2ms
          32.4ms         9.2ms          8.5ms          6.0ms          10.6m
s         9.2ms          32.4ms         8.4ms          
sin(20x) + sin(x) + x    33.2ms         101.0ms        17.1ms         12.1m
s         25.1ms         9.5ms          19.1ms         9.5ms          16.9m
s         12.1ms         24.7ms         19.0ms         
x³ - 2x² +               16.0ms         9.7ms          3.9ms          4.6ms
          117.8ms        5.6ms          4.3ms          3.4ms          4.1ms
          4.7ms          118.3ms        4.2ms          
x·sin(1/x) - 0.          25.9ms         FAIL           10.2ms         40.6m
s         19.6ms         7.5ms          7.0ms          6.8ms          10.3m
s         16.3ms         18.3ms         6.7ms          
\n=========================================================================
=======
Notes:
...
------------------------------------------------------------
1    | ModAB (BNS)        | 100.0      % | 256.112     \n2    | Roots.jl   
        | 100.0      % | 250.987     \n3    | ITP (BNS)          | 100.0   
   % | 239.638     \n4    | Alefeld (BNS)      | 87.5       % | 197.174    
 \n5    | Ridders (SNS)      | 100.0      % | 184.287     \n6    | Ridder (
BNS)       | 100.0      % | 184.286     \n7    | Brent (SNS)        | 100.0
      % | 155.208     \n8    | Brent (BNS)        | 100.0      % | 155.207 
    \n9    | Bisection (BNS)    | 100.0      % | 6.558       \n10   | Bisec
tion (SNS)    | 100.0      % | 6.558       \n11   | Falsi (SNS)        | 10
...
```
Status `~/sandbox/tmp_20260723_161333_68786/SciMLBenchmarks.jl/benchmarks/IntervalNonlinearProblem/Project.toml`
...
```
Status `~/sandbox/tmp_20260723_161333_68786/SciMLBenchmarks.jl/benchmarks/IntervalNonlinearProblem/Manifest.toml`
