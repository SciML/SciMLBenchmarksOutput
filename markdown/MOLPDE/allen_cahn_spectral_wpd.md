...
EFunction{true, SciMLBase.FullSpecialize, typeof(Main.var"##WeaveSandBox#10
69".allen_cahn), LinearAlgebra.UniformScaling{Bool}, Nothing, Nothing, Noth
ing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing
, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED), Nothing, Nothing}, 
LinearAlgebra.UniformScaling{Bool}, Vector{Float64}, Nothing, Nothing, Noth
ing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing
, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED), Nothing, Nothing}, 
Float64, Vector{Float64}}, Vector{Float64}, Vector{Float64}, Vector{Float64
}}, ::Type{ComplexF64})
