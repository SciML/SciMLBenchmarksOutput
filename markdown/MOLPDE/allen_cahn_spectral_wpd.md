...
}, SciMLBase.ODEFunction{true, SciMLBase.FullSpecialize, typeof(Main.var"##
WeaveSandBox#3111".allen_cahn), LinearAlgebra.UniformScaling{Bool}, Nothing
...
ED), Nothing, Nothing}, LinearAlgebra.UniformScaling{Bool}, Vector{Float64}
, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, N
othing, Nothing, Nothing, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERV
ED), Nothing, Nothing}, Float64, Vector{Float64}}, Vector{Float64}, Tuple{V
ector{Float64}, Vector{Float64}}, typeof(SparseDiffTools.num_jacvec), typeo
f(SparseDiffTools.num_jacvec!)}, Nothing, Nothing, Nothing, NamedTuple{(:is
linear, :isconvertible, :isconstant, :opnorm, :issymmetric, :ishermitian, :
isposdef, :isinplace, :outofplace, :has_mul5, :ifcache, :T, :batch, :size, 
:sizes, :eltypes, :accepted_kwargs, :kwargs), Tuple{Bool, Bool, Bool, Nothi
ng, Bool, Bool, Bool, Bool, Bool, Bool, Bool, DataType, Bool, Tuple{Int64, 
Int64}, Tuple{Tuple{Int64}, Tuple{Int64}}, Tuple{DataType, DataType}, Tuple
{}, Dict{Symbol, Any}}}, Vector{Float64}, Float64, Tuple{Vector{Float64}, V
ector{Float64}}}, ::Type{ComplexF64})
...
SciMLBenchmarks.weave_file("benchmarks/MOLPDE","allen_cahn_spectral_wpd.jmd")
```
