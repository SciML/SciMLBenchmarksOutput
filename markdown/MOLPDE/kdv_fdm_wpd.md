...
CNLF2
SBDF2
407.568120 seconds (194.93 M allocations: 11.729 GiB, 2.27% gc time, 2.14% 
compilation time)
```
...
ARKODE4
ARKODE5
4429.510715 seconds (1.21 G allocations: 80.989 GiB, 1.50% gc time, 0.25% c
ompilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
145.527293 seconds (10.12 M allocations: 28.649 GiB, 2.14% gc time, 5.01% c
ompilation time)
```
