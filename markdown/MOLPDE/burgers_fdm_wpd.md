...
CNLF2
SBDF2
1249.389516 seconds (163.03 M allocations: 9.815 GiB, 0.71% gc time, 0.93% 
...
NorsettEuler (m=20)
ETDRK2 (caching)
506.466478 seconds (11.36 M allocations: 126.560 GiB, 1.74% gc time, 1.33% 
compilation time)
```
...
ARKODE4
ARKODE5
14809.524186 seconds (964.98 M allocations: 61.026 GiB, 0.38% gc time, 0.09
% compilation time)
```
...
HochOst4 (caching)
HochOst4 (m=5)
1654.335763 seconds (20.86 M allocations: 465.685 GiB, 1.84% gc time, 0.80%
 compilation time)
```
...
SciMLBenchmarks.weave_file("benchmarks/MOLPDE","burgers_fdm_wpd.jmd")
```
