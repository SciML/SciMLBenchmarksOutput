...
CNLF2
SBDF2
1270.286683 seconds (37.79 M allocations: 2.772 GiB, 0.07% gc time, 2.91% c
ompilation time)
```
...
NorsettEuler (m=20)
ETDRK2 (caching)
535.126117 seconds (32.93 M allocations: 124.871 GiB, 1.06% gc time, 5.67% 
compilation time)
```
...
ARKODE4
ARKODE5
14564.636573 seconds (46.41 M allocations: 3.252 GiB, 0.01% gc time, 0.25% 
compilation time)
```
...
HochOst4 (caching)
HochOst4 (m=5)
1629.473645 seconds (35.47 M allocations: 460.387 GiB, 0.82% gc time, 2.84%
 compilation time)
```
