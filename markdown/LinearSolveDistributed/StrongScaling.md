...
t64, residual::Float64, iters::Int64, retcode::SubString{String}}}:
 (ranks = 1, N = 1000000, nnz = 4996000, time = 4.70490848, residual = 6.26
9221372956215e-9, iters = 17, retcode = "Success")
 (ranks = 2, N = 1000000, nnz = 4996000, time = 3.153901347, residual = 5.5
75851590361861e-9, iters = 17, retcode = "Success")
 (ranks = 4, N = 1000000, nnz = 4996000, time = 1.760065026, residual = 6.5
146144157119726e-9, iters = 17, retcode = "Success")
 (ranks = 8, N = 1000000, nnz = 4996000, time = 0.950296703, residual = 4.6
10872532524925e-9, iters = 17, retcode = "Success")
```
...
------+------------+-------+---------+------------+-----------+--------
    1 |      0.144 |    13 |    1.00 |     100.0% |  4.86e-09 | Success
    2 |     0.1156 |    13 |    1.25 |      62.3% |  8.30e-09 | Success
    4 |    0.07405 |    13 |    1.94 |      48.6% |  3.79e-09 | Success
    8 |    0.04806 |    13 |    3.00 |      37.5% |  5.32e-09 | Success

N = 1000000
ranks |  time (s)  | iters | speedup | efficiency | residual  | retcode
------+------------+-------+---------+------------+-----------+--------
    1 |      4.705 |    17 |    1.00 |     100.0% |  6.27e-09 | Success
    2 |      3.154 |    17 |    1.49 |      74.6% |  5.58e-09 | Success
    4 |       1.76 |    17 |    2.67 |      66.8% |  6.51e-09 | Success
    8 |     0.9503 |    17 |    4.95 |      61.9% |  4.61e-09 | Success
([1.0, 1.4917741433083576, 2.673144690962117, 4.9509889544465775], [1.0, 0.
7458870716541788, 0.6682861727405293, 0.6188736193058222])
```
