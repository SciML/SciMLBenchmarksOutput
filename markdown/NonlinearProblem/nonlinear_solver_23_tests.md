...
```
[Info] Solver Default PolyAlg. returned retcode Success with an residual no
rm = 6.942141306254257e-12.
[Info] Solver Newton Raphson returned retcode Success with an residual norm
 = 6.942141306254257e-12.
[Info] Solver NR (HagerZhang) returned retcode Success with an residual nor
m = 2.6951396045471476e-9.
[Info] Solver NR (MoreThuente) returned retcode Success with an residual no
...
[Warn] Solver NR (HagerZhang) had a very large residual (norm = 0.919563903
569308).
[Info] Solver NR (MoreThuente) returned retcode Success with an residual no
rm = 7.54840412398039e-10.
[Info] Solver NR (BackTracking) returned retcode Success with an residual n
...
io = IOBuffer()
println(io, "```@raw html")
pretty_table(io, solver_outcomes; backend = :html,
...
<table>
  <thead>
    <tr class = "columnLabelRow">
      <th style = "font-weight: bold; text-align: center;">Default PolyAlg.</th>
      <th style = "font-weight: bold; text-align: center;">Newton Raphson</th>
      <th style = "font-weight: bold; text-align: center;">NR (HagerZhang)</th>
      <th style = "font-weight: bold; text-align: center;">NR (MoreThuente)</th>
      <th style = "font-weight: bold; text-align: center;">NR (BackTracking)</th>
      <th style = "font-weight: bold; text-align: center;">Trust Region</th>
      <th style = "font-weight: bold; text-align: center;">TR (NLsolve Update)</th>
      <th style = "font-weight: bold; text-align: center;">TR (Nocedal Wright)</th>
      <th style = "font-weight: bold; text-align: center;">TR (Hei)</th>
      <th style = "font-weight: bold; text-align: center;">TR (Yuan)</th>
      <th style = "font-weight: bold; text-align: center;">TR (Bastin)</th>
      <th style = "font-weight: bold; text-align: center;">TR (Fan)</th>
      <th style = "font-weight: bold; text-align: center;">Levenberg-Marquardt</th>
      <th style = "font-weight: bold; text-align: center;">LM with Cholesky</th>
      <th style = "font-weight: bold; text-align: center;">LM (α_geodesic=0.5)</th>
      <th style = "font-weight: bold; text-align: center;">LM (α_geodesic=0.5) Chol.</th>
      <th style = "font-weight: bold; text-align: center;">LM (no Accln.)</th>
      <th style = "font-weight: bold; text-align: center;">LM (no Accln.) Chol.</th>
      <th style = "font-weight: bold; text-align: center;">Pseudo Transient</th>
      <th style = "font-weight: bold; text-align: center;">Powell [MINPACK]</th>
      <th style = "font-weight: bold; text-align: center;">LM [MINPACK]</th>
      <th style = "font-weight: bold; text-align: center;">NR [NLsolve.jl]</th>
      <th style = "font-weight: bold; text-align: center;">TR [NLsolve.jl]</th>
      <th style = "font-weight: bold; text-align: center;">NR [Sundials]</th>
      <th style = "font-weight: bold; text-align: center;">NR LineSearch [Sundials]</th>
    </tr>
  </thead>
  <tbody>
    <tr class = "dataRow">
