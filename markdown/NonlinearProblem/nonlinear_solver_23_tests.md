...
function plot_collective_benchmark(prob_name, wp_general, wp_NR, wp_TR, wp_LM)
    ...
    colors = cgrad(:berlin, length(solvers_all); categorical = true)
    ...
    fig = with_theme(plot_theme) do
        ...
        for i in 1:2, j in 1:2
            ...
            ax = Axis(fig[i + 1, j], ylabel = j == 1 ? L"Time $\mathbf{(s)}$" : "",
                ...
                xlabel = i == 2 ? L"Error: $\mathbf{f(u^\ast)}$ $\mathbf{L_{\infty}}-\mathrm{\mathbf{norm}}$" : "",
...
[Warn] Solver Pseudo Transient had a very large residual (norm = 2.79971086
1575872e11).
[Warn] Solver Powell (MINPACK) had a very large residual (norm = 4.39999999
99999995).
[Warn] Solver LM (MINPACK) had a very large residual (norm = 0.000852392313
1068534).
...
[Warn] Solver NR (Sundials) had a very large residual (norm = 4.10304445231
50355e7).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 5.7505444850392e-10.
```
...
= 9.823952331145566e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 9.823952331145566e-9.
```
...
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 1.0528133920217897e-10.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.7719525846615625e-10.
```
...
[Warn] Solver NR (Sundials) had a very large residual (norm = 2.24565442257
04483e11).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.908545099738035e-9.
```
...
[Info] Solver LM (MINPACK) returned retcode Success with an residual norm =
 8.661763207506094e-17.
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
m = 1.146398379185431e-14.
[Info] Solver TR (NLsolve.jl) returned retcode Success with an residual nor
m = 1.1102230246251565e-14.
[Warn] Solver NR (Sundials) had a very large residual (norm = 43118.5803490
7).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 2.7857959896373472e-9.
```
...
9906963423509e-12.
[Info] Solver Levenberg-Marquardt returned retcode Success with an residual
 norm = 5.698641558637974e-10.
[Info] Solver LM with Cholesky returned retcode Success with an residual no
rm = 5.696234595120586e-10.
[Info] Solver LM (α_geodesic=0.5) returned retcode Success with an residual
 norm = 4.258127184186833e-11.
[Info] Solver LM (α_geodesic=0.5) Chol. returned retcode Success with an re
sidual norm = 4.242606266302573e-11.
[Info] Solver LM (no Accln.) returned retcode Success with an residual norm
 = 9.953438073750931e-11.
[Info] Solver LM (no Accln.) Chol. returned retcode Success with an residua
l norm = 9.953438073750931e-11.
[Info] Solver Pseudo Transient returned retcode Success with an residual no
rm = 5.8986529237470275e-9.
[Info] Solver Powell (MINPACK) returned retcode Success with an residual no
rm = 2.222690781428227e-12.
[Info] Solver LM (MINPACK) returned retcode Success with an residual norm =
 4.1598668953923834e-15.
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
m = 4.200216563443604e-13.
[Info] Solver TR (NLsolve.jl) returned retcode Success with an residual nor
m = 7.246328363741394e-10.
[Warn] Solver NR (Sundials) had a very large residual (norm = 10.8968906018
50592).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 9.048521293353318e-9.
```
...
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 1.2562341722421877e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.8266332335592494e-9.
```
...
[Warn] Solver NR (Sundials) had a very large residual (norm = 6.15096013252
5852e29).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 5.469300123905896e-9.
```
...
m = 3.0531133177191805e-16.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 1.4191641750649353e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.4191641750649353e-9.
```
...
m = 1.304512053934559e-15.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 8.794850236970575e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 8.794850236970575e-9.
```
...
3675675534).
[Warn] Solver LM (α_geodesic=0.5) had a very large residual (norm = 0.00441
6795838331683).
...
[Warn] Solver NR (Sundials) had a very large residual (norm = 24.0231355926
82003).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.373655786340855e-9.
```
...
m = 7.548405234203415e-10.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 5.775745437475166e-10.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 5.775745437475166e-10.
```
...
m = 9.35947180868979e-9.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 3.907084933363336e-10.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 3.907084933363336e-10.
```
...
9364838e-5).
[Warn] Solver LM (MINPACK) had a very large residual (norm = 1.606206659118
867e-5).
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
...
m = 1.1102230246251565e-16.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 7.356216746856603e-10.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.411651795457658e-9.
```
...
[Warn] Solver Powell (MINPACK) had a very large residual (norm = 4.24408543
1537152e-6).
[Warn] Solver LM (MINPACK) had a very large residual (norm = 1.593106166283
8186e-5).
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
m = 1.1102230246251565e-16.
[Info] Solver TR (NLsolve.jl) returned retcode Success with an residual nor
...
= 7.356216746856603e-10.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.4110547175150145e-9.
```
...
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 1.4388490399142029e-12.
```
...
[Info] Solver LM (MINPACK) returned retcode Success with an residual norm =
 7.226823794985482e-27.
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
m = 8.166545633181853e-9.
[Info] Solver TR (NLsolve.jl) returned retcode Success with an residual nor
m = 1.890631918127139e-13.
[Warn] Solver NR (Sundials) had a very large residual (norm = 15.5027757417
21951).
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 6.88413896737102e-9.
```
...
= 9.15473337849735e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 9.15473337849735e-9.
```
...
m = 0.0.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 3.5473471473362887e-9.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 5.29020237668436e-10.
```
...
[Warn] Solver Levenberg-Marquardt had a very large residual (norm = 5.97252
8495064161).
[Warn] Solver LM with Cholesky had a very large residual (norm = 5.17364384
60190115).
[Warn] Solver LM (α_geodesic=0.5) had a very large residual (norm = 6.02921
9599078573).
...
537315).
[Warn] Solver NR (Sundials) had a very large residual (norm = 6.22001315237
5471e10).
...
26250634458574e-11.
[Info] Solver Levenberg-Marquardt returned retcode Success with an residual
 norm = 2.319087144542209e-10.
[Info] Solver LM with Cholesky returned retcode Success with an residual no
rm = 2.3191071285566522e-10.
[Info] Solver LM (α_geodesic=0.5) returned retcode Success with an residual
 norm = 2.0244250720224954e-11.
[Info] Solver LM (α_geodesic=0.5) Chol. returned retcode Success with an re
sidual norm = 2.023747835977474e-11.
[Info] Solver LM (no Accln.) returned retcode Success with an residual norm
...
[Info] Solver LM (MINPACK) returned retcode Success with an residual norm =
 7.552744017741997e-17.
[Info] Solver NR (NLsolve.jl) returned retcode Success with an residual nor
m = 6.661338147750939e-16.
[Info] Solver TR (NLsolve.jl) returned retcode Success with an residual nor
m = 2.5139568204934903e-10.
[Info] Solver NR (Sundials) returned retcode Success with an residual norm 
= 3.006483950684924e-13.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 9.815370738408546e-12.
```
...
= 7.105427357601002e-15.
[Info] Solver NR LineSearch (Sundials) returned retcode Success with an res
idual norm = 7.105427357601002e-15.
```
...
fig = begin
    ...
    with_theme(plot_theme) do
        ...
        fig[:, 0] = Label(fig, "Time (s)", fontsize = 20, tellheight = false, font = :bold,
            rotation = π / 2)
        fig[end + 1, :] = Label(fig,
            L"Error: $\mathbf{f(u^\ast)}$ $\mathbf{L_{\infty}}-\mathrm{\mathbf{norm}}$",
            fontsize = 20, tellwidth = false, font = :bold)

        Legend(fig[5, 4:5], [[l, sc] for (l, sc) in zip(ls, scs)],
            labels, "Successful Solvers";
            framevisible=true, framewidth = STROKEWIDTH, orientation = :horizontal,
            titlesize = 16, nbanks = 6, labelsize = 16,
