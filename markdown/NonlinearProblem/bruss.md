...
```
Error: Invalid attribute strokewidth for plot type MakieCore.Plot{Makie.spy
, Tuple{MakieCore.EndPoints{Float64}, MakieCore.EndPoints{Float64}, SparseA
rrays.SparseMatrixCSC{Float64, Int64}}}.

The available plot attributes for MakieCore.Plot{Makie.spy, Tuple{MakieCore
.EndPoints{Float64}, MakieCore.EndPoints{Float64}, SparseArrays.SparseMatri
xCSC{Float64, Int64}}} are:

alpha        depth_shift   inspectable      marker_gap  ssao          
clip_planes  framecolor    inspector_clear  markersize  transformation
color        framesize     inspector_hover  model       transparency  
colormap     framevisible  inspector_label  nan_color   visible       
colorrange   fxaa          lowclip          overdraw                  
colorscale   highclip      marker           space                     
...
```
Error: AssertionError: f.sparsity isa ADTypes.AbstractSparsityDetector
Stacktrace:
  [1] construct_concrete_adtype(f::SciMLBase.NonlinearFunction{true, SciMLB
ase.FullSpecialize, Main.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6
"{Int64, StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrec
ision{Float64}, Int64}}, LinearAlgebra.UniformScaling{Bool}, Nothing, Nothi
ng, Nothing, Nothing, Nothing, Nothing, SparseDiffTools.ApproximateJacobian
Sparsity{Random.TaskLocalRNG, SparseDiffTools.GreedyD1Color, Nothing}, Noth
ing, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing,
 Nothing, Nothing}, ad::ADTypes.AutoPolyesterForwardDiff{11, Nothing})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/internal/jacobian.jl:
242
  [2] construct_concrete_adtype(f::SciMLBase.NonlinearFunction{true, SciMLB
ase.FullSpecialize, Main.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6
"{Int64, StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrec
ision{Float64}, Int64}}, LinearAlgebra.UniformScaling{Bool}, Nothing, Nothi
ng, Nothing, Nothing, Nothing, Nothing, SparseDiffTools.ApproximateJacobian
Sparsity{Random.TaskLocalRNG, SparseDiffTools.GreedyD1Color, Nothing}, Noth
ing, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing,
 Nothing, Nothing}, ad::ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff
{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/internal/jacobian.jl:
330
  [3] NonlinearSolve.JacobianCache(prob::SciMLBase.NonlinearProblem{Vector{
Float64}, true, NTuple{4, Float64}, SciMLBase.NonlinearFunction{true, SciML
Base.FullSpecialize, Main.var"##WeaveSandBox#225".var"#brusselator_2d_loop#
6"{Int64, StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePre
cision{Float64}, Int64}}, LinearAlgebra.UniformScaling{Bool}, Nothing, Noth
ing, Nothing, Nothing, Nothing, Nothing, SparseDiffTools.ApproximateJacobia
nSparsity{Random.TaskLocalRNG, SparseDiffTools.GreedyD1Color, Nothing}, Not
hing, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing
, Nothing, Nothing}, @Kwargs{}, SciMLBase.StandardNonlinearProblem}, alg::N
onlinearSolve.GeneralizedFirstOrderAlgorithm{nothing, :NewtonRaphson, Nonli
nearSolve.NoLineSearch, Missing, NonlinearSolve.NewtonDescent{Nothing, type
of(NonlinearSolve.DEFAULT_PRECS)}, ADTypes.AutoSparse{ADTypes.AutoPolyester
ForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlg
orithm}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, 
ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, Nothing}, f::SciM
LBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Main.var"##WeaveSan
dBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Float64, Base.Twi
cePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}}, LinearAlgebra.
UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing,
 SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLocalRNG, SparseDif
fTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, typeof(SciMLBase
.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, fu_::Vector{Float64
}, u::Vector{Float64}, p::NTuple{4, Float64}; stats::SciMLBase.NLStats, aut
odiff::ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, AD
Types.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, vjp_autodiff::Nothi
ng, jvp_autodiff::ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, N
othing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, linsolve
::Nothing)
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/internal/jacobian.jl:
65
  [4] __init(::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{4, 
Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Main.
var"##WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Flo
at64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}}, 
LinearAlgebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, Not
hing, Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLocal
RNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, ty
peof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwar
gs{}, SciMLBase.StandardNonlinearProblem}, ::NonlinearSolve.GeneralizedFirs
tOrderAlgorithm{nothing, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missi
ng, NonlinearSolve.NewtonDescent{Nothing, typeof(NonlinearSolve.DEFAULT_PRE
CS)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADT
ypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSparse{A
DTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, A
DTypes.NoColoringAlgorithm}, Nothing}; stats::SciMLBase.NLStats, alias_u0::
Bool, maxiters::Int64, abstol::Float64, reltol::Float64, maxtime::Nothing, 
termination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, Nothing},
 internalnorm::Function, linsolve_kwargs::@NamedTuple{}, kwargs::@Kwargs{})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/core/generalized_firs
t_order.jl:175
  [5] __solve(::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{4,
 Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Main
.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Fl
oat64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}},
 LinearAlgebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, No
thing, Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLoca
lRNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, t
ypeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwa
rgs{}, SciMLBase.StandardNonlinearProblem}, ::NonlinearSolve.GeneralizedFir
stOrderAlgorithm{nothing, :NewtonRaphson, NonlinearSolve.NoLineSearch, Miss
ing, NonlinearSolve.NewtonDescent{Nothing, typeof(NonlinearSolve.DEFAULT_PR
ECS)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, AD
Types.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSparse{
ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, 
ADTypes.NoColoringAlgorithm}, Nothing}; stats::SciMLBase.NLStats, kwargs::@
Kwargs{abstol::Float64, reltol::Float64, termination_condition::DiffEqBase.
AbsNormTerminationMode{Nothing, Nothing}})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/core/generic.jl:3
  [6] solve_call(_prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, N
Tuple{4, Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpeciali
ze, Main.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRan
geLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, 
Int64}}, LinearAlgebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Not
hing, Nothing, Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.
TaskLocalRNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, No
thing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothin
g}, @Kwargs{}, SciMLBase.StandardNonlinearProblem}, args::NonlinearSolve.Ge
neralizedFirstOrderAlgorithm{nothing, :NewtonRaphson, NonlinearSolve.NoLine
Search, Missing, NonlinearSolve.NewtonDescent{Nothing, typeof(NonlinearSolv
e.DEFAULT_PRECS)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, 
Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes
.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsi
tyDetector, ADTypes.NoColoringAlgorithm}, Nothing}; merge_callbacks::Bool, 
kwargshandle::Nothing, kwargs::@Kwargs{abstol::Float64, reltol::Float64, te
rmination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, Nothing}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:612
  [7] solve_up(prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTup
le{4, Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize,
 Main.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeL
en{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int
64}}, LinearAlgebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothin
g, Nothing, Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.Tas
kLocalRNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothi
ng, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing},
 @Kwargs{}, SciMLBase.StandardNonlinearProblem}, sensealg::Nothing, u0::Vec
tor{Float64}, p::NTuple{4, Float64}, args::NonlinearSolve.GeneralizedFirstO
rderAlgorithm{nothing, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing
, NonlinearSolve.NewtonDescent{Nothing, typeof(NonlinearSolve.DEFAULT_PRECS
)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTyp
es.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSparse{ADT
ypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADT
ypes.NoColoringAlgorithm}, Nothing}; kwargs::@Kwargs{abstol::Float64, relto
l::Float64, termination_condition::DiffEqBase.AbsNormTerminationMode{Nothin
g, Nothing}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:1076
  [8] solve(prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{
4, Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Ma
in.var"##WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{
...
Nothing, Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLo
calRNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing,
 typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @K
wargs{}, SciMLBase.StandardNonlinearProblem}, args::NonlinearSolve.Generali
zedFirstOrderAlgorithm{nothing, :NewtonRaphson, NonlinearSolve.NoLineSearch
, Missing, NonlinearSolve.NewtonDescent{Nothing, typeof(NonlinearSolve.DEFA
ULT_PRECS)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothin
g}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoS
parse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDete
ctor, ADTypes.NoColoringAlgorithm}, Nothing}; sensealg::Nothing, u0::Nothin
g, p::Nothing, wrap::Val{true}, kwargs::@Kwargs{abstol::Float64, reltol::Fl
oat64, termination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, No
thing}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:1064
  [9] (::Main.var"##WeaveSandBox#225".var"#__benchmark_function#21"{Int64, 
Int64, NonlinearSolve.GeneralizedFirstOrderAlgorithm{nothing, :NewtonRaphso
n, NonlinearSolve.NoLineSearch, Missing, NonlinearSolve.NewtonDescent{Nothi
ng, typeof(NonlinearSolve.DEFAULT_PRECS)}, ADTypes.AutoSparse{ADTypes.AutoP
olyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoCol
oringAlgorithm}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, No
thing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, Nothing},
 String})()
    @ Main.var"##WeaveSandBox#225" /cache/build/exclusive-amdci1-0/julialan
g/scimlbenchmarks-dot-jl/benchmarks/NonlinearProblem/bruss.jmd:58
 [10] (::Main.var"##WeaveSandBox#225".var"#2#4"{Timer, Base.GenericConditio
n{ReentrantLock}, Main.var"##WeaveSandBox#225".var"#__benchmark_function#21
"{Int64, Int64, NonlinearSolve.GeneralizedFirstOrderAlgorithm{nothing, :New
tonRaphson, NonlinearSolve.NoLineSearch, Missing, NonlinearSolve.NewtonDesc
ent{Nothing, typeof(NonlinearSolve.DEFAULT_PRECS)}, ADTypes.AutoSparse{ADTy
pes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADTy
pes.NoColoringAlgorithm}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDi
ff{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, 
Nothing}, String}})()
    @ Main.var"##WeaveSandBox#225" /cache/build/exclusive-amdci1-0/julialan
g/scimlbenchmarks-dot-jl/benchmarks/NonlinearProblem/bruss.jmd:12
```
...
```
Error: BoundsError: attempt to access 10-element Vector{NamedTuple{(:pkg, :
sparsity, :name, :alg)}} at index [[1, 140648035780232, 140648035450296, 14
0638645304712, 140648035464816, 140648035510920, 140638645304792, 140638645
304832, 140638645304872, 140638645304912]]
```
...
hing, Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing
, Nothing, Nothing}, @Kwargs{}, SciMLBase.StandardNonlinearProblem}, alg::N
onlinearSolve.GeneralizedFirstOrderAlgorithm{true, :NewtonRaphson, Nonlinea
rSolve.NoLineSearch, Missing, NonlinearSolve.NewtonDescent{LinearSolve.Kryl
ovJL{typeof(Krylov.gmres!), Int64, Nothing, Tuple{}, @Kwargs{}}, typeof(Mai
n.var"##WeaveSandBox#225".incompletelu)}, ADTypes.AutoSparse{ADTypes.AutoPo
lyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColo
ringAlgorithm}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Not
hing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, Nothing}, 
f::SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Main.var"##W
eaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Float64, B
ase.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}}, LinearA
lgebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, Nothing, N
othing, SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLocalRNG, Sp
arseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, typeof(Sc
iMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, fu_::Vector{
Float64}, u::Vector{Float64}, p::NTuple{4, Float64}; stats::SciMLBase.NLSta
ts, autodiff::ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothi
ng}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, vjp_autodiff
::Nothing, jvp_autodiff::ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDif
f{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, l
insolve::LinearSolve.KrylovJL{typeof(Krylov.gmres!), Int64, Nothing, Tuple{
}, @Kwargs{}})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/internal/jacobian.jl:
65
...
peof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwar
gs{}, SciMLBase.StandardNonlinearProblem}, ::NonlinearSolve.GeneralizedFirs
tOrderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing,
 NonlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmres!), I
nt64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#225".inc
ompletelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothin
g}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoS
parse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDete
ctor, ADTypes.NoColoringAlgorithm}, Nothing}; stats::SciMLBase.NLStats, ali
as_u0::Bool, maxiters::Int64, abstol::Float64, reltol::Float64, maxtime::No
thing, termination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, No
thing}, internalnorm::Function, linsolve_kwargs::@NamedTuple{abstol::Float6
4, reltol::Float64}, kwargs::@Kwargs{})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/core/generalized_firs
t_order.jl:175
  [5] __solve(::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{4,
...
ypeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwa
rgs{}, SciMLBase.StandardNonlinearProblem}, ::NonlinearSolve.GeneralizedFir
stOrderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing
, NonlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmres!), 
Int64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#225".in
completelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothi
ng}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.Auto
Sparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDet
ector, ADTypes.NoColoringAlgorithm}, Nothing}; stats::SciMLBase.NLStats, kw
args::@Kwargs{abstol::Float64, reltol::Float64, linsolve_kwargs::@NamedTupl
e{abstol::Float64, reltol::Float64}, termination_condition::DiffEqBase.AbsN
ormTerminationMode{Nothing, Nothing}})
    @ NonlinearSolve /cache/julia-buildkite-plugin/depots/5b300254-1738-498
9-ae0a-f4d2d937f953/packages/NonlinearSolve/y3arX/src/core/generic.jl:3
  [6] solve_call(_prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, N
Tuple{4, Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpeciali
...
thing, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothin
g}, @Kwargs{}, SciMLBase.StandardNonlinearProblem}, args::NonlinearSolve.Ge
neralizedFirstOrderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSea
rch, Missing, NonlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Kryl
ov.gmres!), Int64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSan
dBox#225".incompletelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDi
ff{11, Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, 
ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.N
oSparsityDetector, ADTypes.NoColoringAlgorithm}, Nothing}; merge_callbacks:
:Bool, kwargshandle::Nothing, kwargs::@Kwargs{abstol::Float64, reltol::Floa
t64, linsolve_kwargs::@NamedTuple{abstol::Float64, reltol::Float64}, termin
ation_condition::DiffEqBase.AbsNormTerminationMode{Nothing, Nothing}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:612
  [7] solve_up(prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTup
le{4, Float64}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize,
...
ng, typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing},
 @Kwargs{}, SciMLBase.StandardNonlinearProblem}, sensealg::Nothing, u0::Vec
tor{Float64}, p::NTuple{4, Float64}, args::NonlinearSolve.GeneralizedFirstO
rderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing, N
onlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmres!), Int
64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#225".incom
pletelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}
, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSpa
rse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetect
or, ADTypes.NoColoringAlgorithm}, Nothing}; kwargs::@Kwargs{abstol::Float64
, reltol::Float64, linsolve_kwargs::@NamedTuple{abstol::Float64, reltol::Fl
oat64}, termination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, N
othing}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:1076
  [8] solve(prob::SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{
...
calRNG, SparseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing,
 typeof(SciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @K
wargs{}, SciMLBase.StandardNonlinearProblem}, args::NonlinearSolve.Generali
zedFirstOrderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, M
issing, NonlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmr
es!), Int64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#2
25".incompletelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11,
 Nothing}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADType
s.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSpars
ityDetector, ADTypes.NoColoringAlgorithm}, Nothing}; sensealg::Nothing, u0:
:Nothing, p::Nothing, wrap::Val{true}, kwargs::@Kwargs{abstol::Float64, rel
tol::Float64, linsolve_kwargs::@NamedTuple{abstol::Float64, reltol::Float64
}, termination_condition::DiffEqBase.AbsNormTerminationMode{Nothing, Nothin
g}})
    @ DiffEqBase /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae
0a-f4d2d937f953/packages/DiffEqBase/vscDj/src/solve.jl:1064
  [9] (::Main.var"##WeaveSandBox#225".var"#__benchmark_function#28"{Int64, 
SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{4, Float64}, SciML
Base.NonlinearFunction{true, SciMLBase.FullSpecialize, Main.var"##WeaveSand
Box#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Float64, Base.Twic
ePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}}, LinearAlgebra.U
niformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, 
SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLocalRNG, SparseDiff
Tools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, typeof(SciMLBase.
DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwargs{}, SciMLBase
.StandardNonlinearProblem}, Int64, NonlinearSolve.GeneralizedFirstOrderAlgo
rithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing, Nonlinear
Solve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmres!), Int64, Noth
ing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#225".incompletelu)
}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADType
s.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSparse{ADTy
pes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetector, ADTy
pes.NoColoringAlgorithm}, Nothing}, String})()
    @ Main.var"##WeaveSandBox#225" /cache/build/exclusive-amdci1-0/julialan
g/scimlbenchmarks-dot-jl/benchmarks/NonlinearProblem/bruss.jmd:69
 [10] (::Main.var"##WeaveSandBox#225".var"#2#4"{Timer, Base.GenericConditio
n{ReentrantLock}, Main.var"##WeaveSandBox#225".var"#__benchmark_function#28
"{Int64, SciMLBase.NonlinearProblem{Vector{Float64}, true, NTuple{4, Float6
4}, SciMLBase.NonlinearFunction{true, SciMLBase.FullSpecialize, Main.var"##
WeaveSandBox#225".var"#brusselator_2d_loop#6"{Int64, StepRangeLen{Float64, 
Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}}, Linear
Algebra.UniformScaling{Bool}, Nothing, Nothing, Nothing, Nothing, Nothing, 
Nothing, SparseDiffTools.ApproximateJacobianSparsity{Random.TaskLocalRNG, S
parseDiffTools.GreedyD1Color, Nothing}, Nothing, Nothing, Nothing, typeof(S
ciMLBase.DEFAULT_OBSERVED_NO_TIME), Nothing, Nothing, Nothing}, @Kwargs{}, 
SciMLBase.StandardNonlinearProblem}, Int64, NonlinearSolve.GeneralizedFirst
OrderAlgorithm{true, :NewtonRaphson, NonlinearSolve.NoLineSearch, Missing, 
NonlinearSolve.NewtonDescent{LinearSolve.KrylovJL{typeof(Krylov.gmres!), In
t64, Nothing, Tuple{}, @Kwargs{}}, typeof(Main.var"##WeaveSandBox#225".inco
mpletelu)}, ADTypes.AutoSparse{ADTypes.AutoPolyesterForwardDiff{11, Nothing
}, ADTypes.NoSparsityDetector, ADTypes.NoColoringAlgorithm}, ADTypes.AutoSp
arse{ADTypes.AutoPolyesterForwardDiff{11, Nothing}, ADTypes.NoSparsityDetec
tor, ADTypes.NoColoringAlgorithm}, Nothing}, String}})()
    @ Main.var"##WeaveSandBox#225" /cache/build/exclusive-amdci1-0/julialan
g/scimlbenchmarks-dot-jl/benchmarks/NonlinearProblem/bruss.jmd:12
```
...
ame, :alg)}} at index [[1, 8, 140637294808592, 140637294808656, 9, 10, 1406
37294808720, 140637294808784, 140648034934792]]
```
...
```
[Warn] Solver Default PolyAlg threw an error: AssertionError("f.sparsity is
a ADTypes.AbstractSparsityDetector").
[Info] Solver RobustMultiNewton (GMRES) successfully solved the problem (no
rm = 1.1664069101655303e-8).
[Warn] Solver Newton Raphson threw an error: AssertionError("f.sparsity isa
 ADTypes.AbstractSparsityDetector").
[Info] Solver Newton Krylov successfully solved the problem (norm = 1.16640
69101655303e-8).
[Warn] Solver Trust Region threw an error: AssertionError("f.sparsity isa A
DTypes.AbstractSparsityDetector").
