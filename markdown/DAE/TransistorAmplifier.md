...
`IDA()` and `DASKR.daskr()` DAE solvers are omitted because IDA crashes with a
Sundials memory corruption (SIGABRT in KINFree) due to the overdetermined
initialization system (14 equations for 4 unknowns) in the MTK DAE formulation.
...
⌃ [961ee093] ModelingToolkit v11.17.0
⌃ [7771a370] ModelingToolkitBase v1.24.0
⌃ [6bb917b9] ModelingToolkitTearing v1.9.0
...
⌃ [bbf590c4] OrdinaryDiffEqCore v3.22.0
...
⌃ [0a514795] SparseMatrixColorings v0.4.25
⌃ [276daf66] SpecialFunctions v2.7.1
  [860ef19b] StableRNGs v1.0.4
⌃ [64909d44] StateSelection v1.5.1
