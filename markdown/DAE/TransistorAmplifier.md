...
DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      ...
      In above,  R1 =  0.0000000000000D+00   R2 =  0.9908493715742D-16
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN                 
      
 DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      
      In above,  R1 =  0.0000000000000D+00   R2 =  0.1585358994519D-15
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN                 
      
 DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      
      In above,  R1 =  0.0000000000000D+00   R2 =  0.6341435978075D-16
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN
```
