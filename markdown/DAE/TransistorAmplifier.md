...
DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      ...
      In above,  R1 =  0.0000000000000D+00   R2 =  0.9908493706602D-16
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN                 
      
 DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      
      In above,  R1 =  0.0000000000000D+00   R2 =  0.1585358993056D-15
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN                 
      
 DASKR--  AT T (=R1) AND STEPSIZE H (=R2) THE                              
      
      In above,  R1 =  0.0000000000000D+00   R2 =  0.6341435972226D-16
 DASKR--  ERROR TEST FAILED REPEATEDLY OR WITH ABS(H)=HMIN
```
