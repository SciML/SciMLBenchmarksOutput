...
1. **Mass-Matrix ODE Form:** The stabilized index-2 system as `M·du/dt = f(u, t)`,
   solved with Rosenbrock, BDF and RADAU methods.
...
computed with RADAU5 at `rtol = atol = 1e-12`. We use it to verify our own
reference solution (Rodas5P at `rtol = atol = 1e-8`), which is the reference
for all work-precision diagrams below.
...
init solve retcode      : Success, ‖residual‖∞ = 2.858824288409778e-15
Rodas5P        retcode = Unstable        reached t = 4.3148 of 1000.0
FBDF           retcode = Unstable        reached t = 4.0291 of 1000.0
QNDF           retcode = Unstable        reached t = 4.0416 of 1000.0
