...
```
Main.var"##WeaveSandBox#232".IDS_func
```
...
```
Main.var"##WeaveSandBox#232".pulse
```
...
```
Main.var"##WeaveSandBox#232".orani_gate!
```
...
Rodas5P: retcode = Success, steps = 2063, t_final = 320.0
  S₀ (V₄₉)  = 0.20404191277712475
  S₁ (V₁₃₀) = 4.997244470272625
  C  (V₁₄₈) = 0.20389854696966322
```
...
Testing DASSL:
  DASSL: retcode = Success, steps = 6934, t_final = 320.0
```
...
```
Reference solution: retcode = Success, npoints = 16533, t_final = 320.0
```
...
59249384433119e-9 ✓
y(305) S₁   |          4.997238455712048 |              4.99724244378 | 7.9
8054791296226e-7 ✓
