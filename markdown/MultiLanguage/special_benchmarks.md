...
developments.
  ...
  - [DifferentialEquations.jl vs MuJoCo and DiffTaichi](https://arxiv.org/abs/2012.06684)
  ...
  - [DiffEqGPU.jl (DifferentialEquations.jl) vs Jax vs PyTorch GPU benchmarks](https://www.sciencedirect.com/science/article/abs/pii/S0045782523007156)
  - [Catalyst.jl (DifferentialEquations.jl / JumpProcesses.jl) vs MATLAB (SimBiology) vs COPASI vs GillesPy2 vs R GillespieSSA](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1011530)
  - [Catalyst.jl (DifferentialEquations.jl / JumpProcesses.jl) vs libroadrunner](https://gist.github.com/TorkelE/f4111832e7166786523a8c799b297f7a#file-roadrunner_comparison-png)
