...
```
VelocityVerlet():          0.001171 seconds (7.71 k allocations: 261.898 Ki
B)
```
...
```
0.004798 seconds (45.33 k allocations: 1.954 MiB)
```
...
```
SymplecticEuler():         0.002843 seconds (24.12 k allocations: 786.992 K
iB)
...
```
SymplecticEuler():         0.014730 seconds (240.12 k allocations: 7.635 Mi
B)
...
```
SymplecticEuler():         0.403384 seconds (2.40 M allocations: 76.300 MiB
, 34.58% gc time)
```
...
```
SymplecticEuler():         3.563311 seconds (24.00 M allocations: 762.945 M
iB, 16.29% gc time)
```
