...
```
100.104955 seconds (182.38 M allocations: 9.133 GiB, 4.45% gc time, 99.72% 
compilation time)
  4.538534 seconds (5.33 M allocations: 289.071 MiB, 99.83% compilation tim
e)
  3.195432 seconds (2.97 M allocations: 167.829 MiB, 99.61% compilation tim
e)
 32.453733 seconds (68.53 M allocations: 3.506 GiB, 4.65% gc time, 99.93% c
ompilation time)
 10.432550 seconds (13.81 M allocations: 737.992 MiB, 1.83% gc time, 99.94%
 compilation time)
  6.282697 seconds (6.37 M allocations: 505.915 MiB, 2.95% gc time, 92.67% 
compilation time)
 77.451042 seconds (40.99 M allocations: 2.022 GiB, 0.94% gc time, 99.89% c
ompilation time: 5% of which was recompilation)
...
DPRKN12 max energy error:			0.003214324563415971	in	101	steps.
TaylorMethod max energy error:			4.405364961712621e-13	in	101	steps.
ExplicitTaylor max energy error:			1.5701573374826694e-10	in	101	steps.
```
...
```
0.007263 seconds (41.24 k allocations: 66.073 MiB)
  0.068709 seconds (4.11 k allocations: 217.305 KiB)
  0.118623 seconds (4.11 k allocations: 219.664 KiB)
  0.236778 seconds (242.67 k allocations: 5.602 MiB)
  0.046246 seconds (92.70 k allocations: 1.917 MiB)
  3.270539 seconds (9.23 M allocations: 2.020 GiB, 23.99% gc time)
  0.112237 seconds (7.57 k allocations: 416.109 KiB, 31.81% compilation tim
e)
Vern9 + ManifoldProjection max energy error:	8.242295734817162e-13	in	162	s
teps.
...
DPRKN12 max energy error:			0.0038629649572641256	in	1001	steps.
TaylorMethod max energy error:			1.9468870959826745e-12	in	1001	steps.
ExplicitTaylor max energy error:			1.5017604937384021e-9	in	1001	steps.
```
...
```
0.671635 seconds (4.11 k allocations: 217.305 KiB)
  1.187964 seconds (4.11 k allocations: 219.664 KiB)
  2.165590 seconds (1.99 M allocations: 38.986 MiB)
  0.449525 seconds (879.89 k allocations: 16.931 MiB)
...
DPRKN12 max energy error:			0.004295171910001727	in	1001	steps.
```
...
```
In place versions:
  0.007440 seconds (41.24 k allocations: 66.035 MiB)
  0.006940 seconds (503 allocations: 28.750 KiB)
  0.012193 seconds (503 allocations: 31.109 KiB)
  0.022793 seconds (24.42 k allocations: 582.766 KiB)
  0.005241 seconds (10.36 k allocations: 236.492 KiB)
  0.345450 seconds (923.28 k allocations: 206.853 MiB)
  0.007497 seconds (302 allocations: 20.453 KiB)
Vern9 + ManifoldProjection max energy error:	8.242295734817162e-13	in	162	s
teps.
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.481659405224491e-12	in	101	steps.
...
Out of place versions:
  3.622926 seconds (3.73 M allocations: 202.159 MiB, 99.84% compilation tim
e)
  1.806929 seconds (1.70 M allocations: 98.986 MiB, 99.44% compilation time
)
  3.433952 seconds (4.36 M allocations: 215.741 MiB, 99.91% compilation tim
e)
  2.766915 seconds (2.67 M allocations: 141.118 MiB, 99.90% compilation tim
e)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.510081114654895e-12	in	101	steps.
Vern9 max energy error:				1.4352963262354024e-12	in	101	steps.
DPRKN12 max energy error:			0.0036987036331623813	in	101	steps.
```
...
```
In place versions:
  0.006800 seconds (503 allocations: 28.750 KiB)
  0.011764 seconds (503 allocations: 31.109 KiB)
  0.024647 seconds (24.42 k allocations: 582.766 KiB)
  0.005065 seconds (10.36 k allocations: 236.305 KiB)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.481659405224491e-12	in	101	steps.
Vern9 max energy error:				8.952838470577262e-13	in	101	steps.
DPRKN12 max energy error:			0.003214324563415971	in	101	steps.
...
Out of place versions:
  0.005643 seconds (35 allocations: 10.055 KiB)
  0.010493 seconds (35 allocations: 11.039 KiB)
  0.002809 seconds (34 allocations: 10.742 KiB)
  0.002294 seconds (5.39 k allocations: 763.438 KiB)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.510081114654895e-12	in	101	steps.
Vern9 max energy error:				1.4352963262354024e-12	in	101	steps.
DPRKN12 max energy error:			0.0036987036331623813	in	101	steps.
...
```
In place versions:
  0.068616 seconds (4.11 k allocations: 217.305 KiB)
  0.118328 seconds (4.11 k allocations: 219.664 KiB)
  0.236042 seconds (242.67 k allocations: 5.602 MiB)
  0.048811 seconds (92.70 k allocations: 1.917 MiB)
KahanLi8 max energy error:			1.028865881380625e-11	in	1001	steps.
SofSpa10 max energy error:			1.48929757415317e-11	in	1001	steps.
Vern9 max energy error:				7.744915819785092e-12	in	1001	steps.
DPRKN12 max energy error:			0.0038629649572641256	in	1001	steps.
...
Out of place versions:
  0.055524 seconds (41 allocations: 72.148 KiB)
  0.102672 seconds (41 allocations: 73.133 KiB)
  0.026523 seconds (40 allocations: 72.836 KiB)
  0.026049 seconds (44.75 k allocations: 7.112 MiB)
KahanLi8 max energy error:			1.028865881380625e-11	in	1001	steps.
SofSpa10 max energy error:			1.48929757415317e-11	in	1001	steps.
Vern9 max energy error:				9.890754881780595e-12	in	1001	steps.
DPRKN12 max energy error:			0.004104307027617438	in	1001	steps.
```
