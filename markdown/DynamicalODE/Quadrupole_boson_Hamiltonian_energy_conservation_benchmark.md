...
```
48.981314 seconds (133.70 M allocations: 7.751 GiB, 9.09% gc time, 99.99% 
compilation time)
  1.888414 seconds (3.69 M allocations: 236.124 MiB, 99.57% compilation tim
e)
  2.052458 seconds (2.79 M allocations: 180.968 MiB, 2.24% gc time, 98.45% 
compilation time)
 28.570658 seconds (92.08 M allocations: 5.517 GiB, 10.02% gc time, 99.94% 
compilation time)
  2.752194 seconds (2.77 M allocations: 182.998 MiB, 99.87% compilation tim
e)
  2.076174 seconds (3.41 M allocations: 352.864 MiB, 4.06% gc time, 90.61% 
compilation time)
Vern9 + ManifoldProjection max energy error:	3.410605131648481e-13	in	317	s
teps.
...
```
0.004913 seconds (40.70 k allocations: 66.917 MiB)
  0.073772 seconds (700.10 k allocations: 61.899 MiB)
  0.123392 seconds (700.10 k allocations: 61.901 MiB)
  0.176156 seconds (1.60 M allocations: 105.255 MiB)
  0.032021 seconds (372.11 k allocations: 17.920 MiB)
  1.586769 seconds (6.38 M allocations: 1.591 GiB, 9.85% gc time)
Vern9 + ManifoldProjection max energy error:	3.410605131648481e-13	in	317	s
teps.
...
```
0.004582 seconds (40.70 k allocations: 66.917 MiB)
  1.821144 seconds (7.00 M allocations: 579.841 MiB, 52.77% gc time)
  1.962801 seconds (7.00 M allocations: 579.844 MiB, 33.08% gc time)
  2.001987 seconds (16.04 M allocations: 1.013 GiB, 16.16% gc time)
  0.331641 seconds (3.72 M allocations: 174.938 MiB)
 13.077320 seconds (63.82 M allocations: 15.904 GiB, 13.44% gc time)
Vern9 + ManifoldProjection max energy error:	3.410605131648481e-13	in	317	s
teps.
...
```
0.006350 seconds (40.70 k allocations: 66.917 MiB, 21.74% gc time)
  4.056876 seconds (14.00 M allocations: 1.171 GiB, 56.30% gc time)
  3.111313 seconds (14.00 M allocations: 1.171 GiB, 15.54% gc time)
 15.157659 seconds (32.09 M allocations: 2.023 GiB, 77.47% gc time)
  0.636878 seconds (7.43 M allocations: 347.531 MiB)
 27.505710 seconds (127.64 M allocations: 31.807 GiB, 17.31% gc time)
Vern9 + ManifoldProjection max energy error:	3.410605131648481e-13	in	317	s
teps.
...
```
In place versions:
  0.004868 seconds (40.70 k allocations: 66.917 MiB)
  0.073710 seconds (700.10 k allocations: 61.899 MiB)
  0.130010 seconds (700.10 k allocations: 61.901 MiB)
  0.175532 seconds (1.60 M allocations: 105.255 MiB)
  0.032317 seconds (372.11 k allocations: 17.920 MiB)
  1.579815 seconds (6.38 M allocations: 1.591 GiB, 8.64% gc time)
Vern9 + ManifoldProjection max energy error:	3.410605131648481e-13	in	317	s
teps.
KahanLi8 max energy error:			1.0530243343964685e-11	in	100002	steps.
SofSpa10 max energy error:			1.5077716852829326e-11	in	100002	steps.
...
Out of place versions:
  1.345975 seconds (2.76 M allocations: 202.492 MiB, 2.30% gc time, 97.98% 
compilation time)
  0.702764 seconds (1.18 M allocations: 92.843 MiB, 93.72% compilation time
)
  1.441413 seconds (2.94 M allocations: 180.208 MiB, 2.44% gc time, 98.26% 
compilation time)
  0.841186 seconds (1.14 M allocations: 78.429 MiB, 98.64% compilation time
)
KahanLi8 max energy error:			1.0530243343964685e-11	in	100002	steps.
SofSpa10 max energy error:			1.5077716852829326e-11	in	100002	steps.
...
```
In place versions:
  0.007316 seconds (70.09 k allocations: 5.806 MiB)
  0.011831 seconds (70.09 k allocations: 5.808 MiB)
  0.014336 seconds (160.71 k allocations: 10.781 MiB)
  0.003074 seconds (37.49 k allocations: 1.872 MiB)
KahanLi8 max energy error:			5.5706550483591855e-12	in	10001	steps.
SofSpa10 max energy error:			3.836930773104541e-12	in	10001	steps.
Vern9 max energy error:				6.679101716144942e-13	in	4865	steps.
DPRKN12 max energy error:			8.242295734817162e-13	in	2195	steps.
...
Out of place versions:
  0.002943 seconds (10.02 k allocations: 1.681 MiB)
  0.004452 seconds (10.02 k allocations: 1.682 MiB)
  0.002132 seconds (4.90 k allocations: 2.762 MiB)
  0.001299 seconds (2.23 k allocations: 604.359 KiB)
KahanLi8 max energy error:			5.5706550483591855e-12	in	10001	steps.
SofSpa10 max energy error:			3.836930773104541e-12	in	10001	steps.
...
```
In place versions:
  0.073080 seconds (700.10 k allocations: 61.899 MiB)
  0.127132 seconds (700.10 k allocations: 61.901 MiB)
  0.175429 seconds (1.60 M allocations: 105.255 MiB)
  0.032445 seconds (372.11 k allocations: 17.920 MiB)
KahanLi8 max energy error:			1.0530243343964685e-11	in	100002	steps.
SofSpa10 max energy error:			1.5077716852829326e-11	in	100002	steps.
Vern9 max energy error:				7.545963853772264e-12	in	48624	steps.
DPRKN12 max energy error:			5.343281372915953e-12	in	21878	steps.
...
Out of place versions:
  0.027652 seconds (100.03 k allocations: 21.886 MiB)
  0.044136 seconds (100.03 k allocations: 21.887 MiB)
  0.019910 seconds (48.67 k allocations: 23.950 MiB)
  0.010986 seconds (21.91 k allocations: 4.989 MiB)
KahanLi8 max energy error:			1.0530243343964685e-11	in	100002	steps.
SofSpa10 max energy error:			1.5077716852829326e-11	in	100002	steps.
Vern9 max energy error:				9.762857189343777e-12	in	48624	steps.
DPRKN12 max energy error:			1.5205614545266144e-12	in	21873	steps.
...
```
In place versions:
  1.840837 seconds (7.00 M allocations: 579.841 MiB, 53.43% gc time)
  1.313025 seconds (7.00 M allocations: 579.844 MiB)
  2.038694 seconds (16.04 M allocations: 1.013 GiB, 16.75% gc time)
  0.320925 seconds (3.72 M allocations: 174.938 MiB)
KahanLi8 max energy error:			4.3968384488835e-11	in	1000001	steps.
SofSpa10 max energy error:			6.492939519375795e-11	in	1000001	steps.
Vern9 max energy error:				6.17461637375527e-11	in	486193	steps.
DPRKN12 max energy error:			3.127809122815961e-11	in	218667	steps.
...
Out of place versions:
  0.312440 seconds (1.00 M allocations: 167.849 MiB, 5.51% gc time)
  0.481468 seconds (1.00 M allocations: 167.850 MiB)
  0.244364 seconds (486.25 k allocations: 215.754 MiB)
  0.111061 seconds (218.71 k allocations: 43.322 MiB)
KahanLi8 max energy error:			4.3968384488835e-11	in	1000001	steps.
SofSpa10 max energy error:			6.492939519375795e-11	in	1000001	steps.
...
```
In place versions:
  2.874783 seconds (14.00 M allocations: 1.171 GiB, 39.47% gc time)
  4.579002 seconds (14.00 M allocations: 1.171 GiB, 42.98% gc time)
  9.367741 seconds (32.09 M allocations: 2.023 GiB, 63.79% gc time)
  0.636116 seconds (7.43 M allocations: 347.531 MiB)
KahanLi8 max energy error:			1.0363976343796821e-10	in	2000002	steps.
SofSpa10 max energy error:			9.750067420100095e-11	in	2000002	steps.
Vern9 max energy error:				1.1236522823310224e-10	in	972365	steps.
DPRKN12 max energy error:			4.389733021525899e-11	in	437324	steps.
...
Out of place versions:
  0.756659 seconds (2.00 M allocations: 395.141 MiB, 13.61% gc time)
  1.175719 seconds (2.00 M allocations: 395.141 MiB, 14.31% gc time)
  0.489461 seconds (972.45 k allocations: 428.591 MiB)
  0.220328 seconds (437.38 k allocations: 83.674 MiB)
KahanLi8 max energy error:			1.0363976343796821e-10	in	2000002	steps.
SofSpa10 max energy error:			9.750067420100095e-11	in	2000002	steps.
