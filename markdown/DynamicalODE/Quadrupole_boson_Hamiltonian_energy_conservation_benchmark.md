...
```
49.657725 seconds (133.54 M allocations: 7.676 GiB, 10.17% gc time, 99.99%
 compilation time)
...
```
0.005777 seconds (28.43 k allocations: 65.900 MiB)
...
```
0.000705 seconds (10.39 k allocations: 636.797 KiB)
...
```
0.007325 seconds (28.39 k allocations: 65.899 MiB, 16.68% gc time)
