...
```
59.867129 seconds (182.97 M allocations: 9.169 GiB, 7.60% gc time, 99.81% 
compilation time)
  3.102629 seconds (5.36 M allocations: 290.382 MiB, 2.45% gc time, 99.78% 
compilation time)
  2.127128 seconds (3.00 M allocations: 169.404 MiB, 99.43% compilation tim
e)
 19.225340 seconds (68.56 M allocations: 3.507 GiB, 6.70% gc time, 99.91% c
ompilation time)
  6.557277 seconds (13.84 M allocations: 739.830 MiB, 2.99% gc time, 99.93%
 compilation time)
  4.405543 seconds (6.39 M allocations: 507.017 MiB, 5.73% gc time, 89.24% 
compilation time)
 44.546884 seconds (41.27 M allocations: 2.033 GiB, 1.44% gc time, 99.86% c
ompilation time: 6% of which was recompilation)
...
```
0.005747 seconds (41.24 k allocations: 66.074 MiB)
  0.060356 seconds (4.11 k allocations: 217.305 KiB)
  0.112682 seconds (4.11 k allocations: 219.664 KiB)
  0.168850 seconds (242.67 k allocations: 5.602 MiB)
  0.033082 seconds (92.70 k allocations: 1.917 MiB)
  3.354650 seconds (9.23 M allocations: 2.020 GiB, 42.80% gc time)
  0.084527 seconds (7.57 k allocations: 414.781 KiB, 31.30% compilation tim
e)
Vern9 + ManifoldProjection max energy error:	8.242295734817162e-13	in	162	s
teps.
...
```
0.591491 seconds (4.11 k allocations: 217.305 KiB)
  1.124152 seconds (4.11 k allocations: 219.664 KiB)
  1.630712 seconds (1.99 M allocations: 38.986 MiB)
  0.324275 seconds (879.89 k allocations: 16.931 MiB)
...
```
In place versions:
  0.005324 seconds (41.24 k allocations: 66.036 MiB)
  0.006047 seconds (503 allocations: 28.750 KiB)
  0.011501 seconds (503 allocations: 31.109 KiB)
  0.017314 seconds (24.42 k allocations: 582.766 KiB)
  0.003910 seconds (10.36 k allocations: 236.305 KiB)
  0.235383 seconds (923.79 k allocations: 206.894 MiB)
  0.005798 seconds (302 allocations: 20.453 KiB)
Vern9 + ManifoldProjection max energy error:	8.242295734817162e-13	in	162	s
teps.
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.481659405224491e-12	in	101	steps.
...
Out of place versions:
  2.621829 seconds (4.29 M allocations: 237.477 MiB, 99.79% compilation tim
e)
  1.211836 seconds (1.71 M allocations: 99.980 MiB, 99.16% compilation time
)
  2.275183 seconds (4.38 M allocations: 217.080 MiB, 99.89% compilation tim
e)
  1.792789 seconds (2.69 M allocations: 142.069 MiB, 99.86% compilation tim
e)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
...
```
In place versions:
  0.006054 seconds (503 allocations: 28.750 KiB)
  0.011316 seconds (503 allocations: 31.109 KiB)
  0.017279 seconds (24.42 k allocations: 582.766 KiB)
  0.004076 seconds (10.36 k allocations: 236.305 KiB)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.481659405224491e-12	in	101	steps.
Vern9 max energy error:				8.952838470577262e-13	in	101	steps.
DPRKN12 max energy error:			0.003214324563415971	in	101	steps.
...
Out of place versions:
  0.005358 seconds (35 allocations: 10.055 KiB)
  0.010182 seconds (35 allocations: 11.039 KiB)
  0.002364 seconds (34 allocations: 10.742 KiB)
  0.002500 seconds (5.39 k allocations: 763.438 KiB)
KahanLi8 max energy error:			5.215383680479135e-12	in	101	steps.
SofSpa10 max energy error:			3.510081114654895e-12	in	101	steps.
Vern9 max energy error:				1.4352963262354024e-12	in	101	steps.
DPRKN12 max energy error:			0.0036987036331623813	in	101	steps.
...
```
In place versions:
  0.059515 seconds (4.11 k allocations: 217.305 KiB)
  0.113983 seconds (4.11 k allocations: 219.664 KiB)
  0.173417 seconds (242.67 k allocations: 5.602 MiB)
  0.034797 seconds (92.70 k allocations: 1.917 MiB)
KahanLi8 max energy error:			1.028865881380625e-11	in	1001	steps.
SofSpa10 max energy error:			1.48929757415317e-11	in	1001	steps.
Vern9 max energy error:				7.744915819785092e-12	in	1001	steps.
DPRKN12 max energy error:			0.0038629649572641256	in	1001	steps.
...
Out of place versions:
  0.053165 seconds (41 allocations: 72.148 KiB)
  0.101302 seconds (41 allocations: 73.133 KiB)
  0.023108 seconds (40 allocations: 72.836 KiB)
  0.022635 seconds (44.75 k allocations: 7.112 MiB)
KahanLi8 max energy error:			1.028865881380625e-11	in	1001	steps.
SofSpa10 max energy error:			1.48929757415317e-11	in	1001	steps.
