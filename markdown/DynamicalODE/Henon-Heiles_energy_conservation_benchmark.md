...
```
67.332106 seconds (133.95 M allocations: 7.707 GiB, 3.43% gc time, 99.98% 
compilation time: <1% of which was recompilation)
  2.563300 seconds (3.71 M allocations: 239.099 MiB, 99.61% compilation tim
e)
  2.813997 seconds (2.82 M allocations: 184.229 MiB, 1.26% gc time, 99.49% 
compilation time)
 41.398166 seconds (91.97 M allocations: 5.511 GiB, 4.85% gc time, 99.99% c
ompilation time)
  4.207177 seconds (2.75 M allocations: 183.990 MiB, 99.96% compilation tim
e)
  2.203025 seconds (2.30 M allocations: 159.033 MiB, 1.83% gc time, 99.95% 
compilation time)
...
```
0.103256 seconds (755.87 k allocations: 61.341 MiB)
  0.110412 seconds (700.10 k allocations: 61.899 MiB)
  0.158882 seconds (700.10 k allocations: 61.901 MiB)
  0.045797 seconds (308.05 k allocations: 20.115 MiB)
  0.007350 seconds (64.55 k allocations: 3.063 MiB)
  0.000696 seconds (1.52 k allocations: 606.797 KiB)
...
```
1.417569 seconds (7.55 M allocations: 608.811 MiB, 29.22% gc time)
  1.445869 seconds (7.00 M allocations: 579.841 MiB, 23.33% gc time)
  1.549956 seconds (7.00 M allocations: 579.844 MiB)
  0.446137 seconds (3.08 M allocations: 201.754 MiB)
  0.068503 seconds (642.99 k allocations: 31.891 MiB)
  0.000703 seconds (1.52 k allocations: 606.797 KiB)
...
```
6.768404 seconds (37.75 M allocations: 2.955 GiB, 27.69% gc time)
  9.149975 seconds (35.00 M allocations: 2.831 GiB, 39.58% gc time)
 19.716348 seconds (35.00 M allocations: 2.831 GiB, 60.64% gc time)
  8.470158 seconds (15.38 M allocations: 994.786 MiB, 73.13% gc time)
  0.353581 seconds (3.21 M allocations: 152.786 MiB)
  0.000858 seconds (1.52 k allocations: 606.797 KiB)
...
```
In place versions:
  0.098789 seconds (755.87 k allocations: 61.341 MiB)
  0.106765 seconds (700.10 k allocations: 61.899 MiB)
  0.157281 seconds (700.10 k allocations: 61.901 MiB)
  0.045610 seconds (308.05 k allocations: 20.115 MiB)
  0.007346 seconds (64.55 k allocations: 3.063 MiB)
  0.000743 seconds (1.52 k allocations: 606.797 KiB)
Vern9 + ManifoldProjection max energy error:	4.3021142204224816e-15	in	1865
9	steps.
KahanLi8 max energy error:			1.815214645262131e-14	in	100002	steps.
SofSpa10 max energy error:			2.8033131371785203e-14	in	100002	steps.
...
Out of place versions:
  1.935286 seconds (2.87 M allocations: 211.911 MiB, 2.45% gc time, 98.36% 
compilation time)
  0.925906 seconds (1.11 M allocations: 90.429 MiB, 94.71% compilation time
)
  1.794243 seconds (2.81 M allocations: 157.564 MiB, 99.65% compilation tim
e)
  1.074410 seconds (1.08 M allocations: 72.731 MiB, 99.76% compilation time
)
KahanLi8 max energy error:			1.815214645262131e-14	in	100002	steps.
SofSpa10 max energy error:			2.8033131371785203e-14	in	100002	steps.
...
```
In place versions:
  0.009528 seconds (70.09 k allocations: 5.806 MiB)
  0.013881 seconds (70.09 k allocations: 5.808 MiB)
  0.004060 seconds (31.18 k allocations: 2.059 MiB)
  0.000799 seconds (6.69 k allocations: 344.469 KiB)
KahanLi8 max energy error:			4.9404924595819466e-15	in	10001	steps.
SofSpa10 max energy error:			5.440092820663267e-15	in	10001	steps.
Vern9 max energy error:				8.326672684688674e-16	in	940	steps.
DPRKN12 max energy error:			2.498001805406602e-16	in	384	steps.
...
Out of place versions:
  0.003490 seconds (10.02 k allocations: 1.681 MiB)
  0.005125 seconds (10.02 k allocations: 1.682 MiB)
  0.001117 seconds (971 allocations: 500.500 KiB)
  0.000368 seconds (411 allocations: 99.172 KiB)
KahanLi8 max energy error:			4.9404924595819466e-15	in	10001	steps.
SofSpa10 max energy error:			5.440092820663267e-15	in	10001	steps.
...
```
In place versions:
  0.110780 seconds (700.10 k allocations: 61.899 MiB)
  0.151054 seconds (700.10 k allocations: 61.901 MiB)
  0.045719 seconds (308.05 k allocations: 20.115 MiB)
  0.007460 seconds (64.55 k allocations: 3.063 MiB)
KahanLi8 max energy error:			1.815214645262131e-14	in	100002	steps.
SofSpa10 max energy error:			2.8033131371785203e-14	in	100002	steps.
Vern9 max energy error:				4.3021142204224816e-15	in	9330	steps.
DPRKN12 max energy error:			1.0824674490095276e-15	in	3787	steps.
...
Out of place versions:
  0.035591 seconds (100.03 k allocations: 21.886 MiB)
  0.049870 seconds (100.03 k allocations: 21.887 MiB)
  0.005236 seconds (9.37 k allocations: 4.464 MiB)
  0.002586 seconds (3.82 k allocations: 803.484 KiB)
KahanLi8 max energy error:			1.815214645262131e-14	in	100002	steps.
SofSpa10 max energy error:			2.8033131371785203e-14	in	100002	steps.
Vern9 max energy error:				5.523359547510154e-15	in	9330	steps.
DPRKN12 max energy error:			4.440892098500626e-16	in	3787	steps.
...
```
In place versions:
  1.913347 seconds (7.00 M allocations: 579.841 MiB, 43.09% gc time)
  1.562990 seconds (7.00 M allocations: 579.844 MiB)
  0.450822 seconds (3.08 M allocations: 201.754 MiB)
  0.068200 seconds (642.99 k allocations: 31.891 MiB)
KahanLi8 max energy error:			3.161360062620133e-14	in	1000001	steps.
SofSpa10 max energy error:			1.136590821460004e-13	in	1000001	steps.
Vern9 max energy error:				4.427014310692812e-14	in	93214	steps.
DPRKN12 max energy error:			7.632783294297951e-15	in	37812	steps.
...
Out of place versions:
  0.401583 seconds (1.00 M allocations: 167.849 MiB, 15.90% gc time)
  0.540253 seconds (1.00 M allocations: 167.850 MiB)
  0.061932 seconds (93.26 k allocations: 45.374 MiB)
  0.024554 seconds (37.85 k allocations: 10.021 MiB)
KahanLi8 max energy error:			3.161360062620133e-14	in	1000001	steps.
SofSpa10 max energy error:			1.136590821460004e-13	in	1000001	steps.
...
```
In place versions:
  9.175671 seconds (35.00 M allocations: 2.831 GiB, 40.17% gc time)
 20.329174 seconds (35.00 M allocations: 2.831 GiB, 61.31% gc time)
  5.427617 seconds (15.38 M allocations: 994.786 MiB, 58.17% gc time)
  0.363831 seconds (3.21 M allocations: 152.786 MiB)
KahanLi8 max energy error:			1.2331802246023926e-13	in	5000001	steps.
SofSpa10 max energy error:			1.5035195310986182e-13	in	5000001	steps.
Vern9 max energy error:				2.2823409828731656e-13	in	466045	steps.
DPRKN12 max energy error:			4.2799097599299785e-14	in	189039	steps.
...
Out of place versions:
  2.031388 seconds (5.00 M allocations: 839.236 MiB, 8.38% gc time)
  4.278864 seconds (5.00 M allocations: 839.237 MiB, 36.03% gc time)
  0.310342 seconds (466.10 k allocations: 208.068 MiB)
  0.122305 seconds (189.09 k allocations: 39.705 MiB)
KahanLi8 max energy error:			1.2331802246023926e-13	in	5000001	steps.
SofSpa10 max energy error:			1.5035195310986182e-13	in	5000001	steps.
