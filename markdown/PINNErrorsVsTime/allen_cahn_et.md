...
f953/compiled/v1.10/NeuralPDE/jl_7DejyL".
```
...
```
Error: UndefVarError: `CubaCuhre` not defined
```
...
```
Plotting error vs timesError: UndefVarError: `strategies_short_name` not d
efined
```
