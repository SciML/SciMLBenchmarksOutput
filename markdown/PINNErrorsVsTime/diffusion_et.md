...
f953/compiled/v1.10/NeuralPDE/jl_OsSE2h".
```
...
nchmarks-dot-jl/benchmarks/PINNErrorsVsTime/diffusion_et.jmd:5
```
...
```
Error: UndefVarError: `HCubatureJL` not defined
```
...
```
Starting runError: UndefVarError: `minimizers` not defined
```
...
```
Error: UndefVarError: `strategies_short_name` not defined
```
...
⌅ [b2108857] Lux v0.4.14
⌅ [961ee093] ModelingToolkit v8.18.7
