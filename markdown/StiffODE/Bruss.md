...
test_sol = [sol,sol2,sol]
probs = [prob,prob_mtk,fastprob];
```
...
names = ["KenCarp47 KLU","KenCarp47 KLU MTK","KenCarp47 KLU FastBruss",
         "KenCarp47 GMRES", "KenCarp47 GMRES MTK", "KenCarp47 GMRES FastBruss"];
...
⌅ [7ae1f121] ContinuumArrays v0.10.3
