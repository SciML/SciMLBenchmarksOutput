...
```
Error: ArgumentError: Package OrdinaryDiffEqFIRK not found in current path.
- Run `import Pkg; Pkg.add("OrdinaryDiffEqFIRK")` to install the OrdinaryDi
ffEqFIRK package.
```
...
SciMLBenchmarks.weave_file("benchmarks/StiffODE","E5.jmd")
```
