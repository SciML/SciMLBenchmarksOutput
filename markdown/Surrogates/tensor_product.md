...
- ``d``: the dimensionality of the input vector ``x``.
...
```
Python: <module 'numpy' from '/julia/github-runners/amdci1-1/_work/SciMLBen
chmarks.jl/SciMLBenchmarks.jl/benchmarks/Surrogates/.CondaPkg/.pixi/envs/de
fault/lib/python3.12/site-packages/numpy/__init__.py'>
```
...
├────────────────────┼──────────────┼─────────────┤
│      Kriging (SMT) │  3.51665e-18 │ 4.73451e-18 │
│            Kriging │  3.50414e-14 │ 2.42154e-13 │
│ Radial Basis (SMT) │  2.34051e-14 │ 7.90416e-13 │
│        Lobachevsky │   3.7375e-19 │  1.06834e-8 │
│       Radial Basis │  1.02176e-30 │  7.81773e-5 │
│            XGBoost │   0.00176894 │   0.0072459 │
└────────────────────┴──────────────┴─────────────┘
```
...
│              Model │     Time(s) │
├────────────────────┼─────────────┤
│  Original Function │   1.4879e-6 │
│       Radial Basis │   2.2829e-5 │
│ Radial Basis (SMT) │ 0.000409587 │
│            Kriging │ 0.000488426 │
│      Kriging (SMT) │ 0.000702265 │
│        Lobachevsky │  0.00110161 │
│            XGBoost │    0.058834 │
└────────────────────┴─────────────┘
```
...
Environment:
  ...
  JULIA_PYTHONCALL_EXE = /julia/github-runners/amdci1-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Surrogates/.CondaPkg/.pixi/envs/default/bin/python
...
```
Status `/julia/github-runners/amdci1-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Surrogates/Project.toml`
...
```
Status `/julia/github-runners/amdci1-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Surrogates/Manifest.toml`
