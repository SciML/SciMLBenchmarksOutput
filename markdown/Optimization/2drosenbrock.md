...
```
2.090 ms (18065 allocations: 956.80 KiB)
retcode: Failure
...
```
2.366 ms (24665 allocations: 1.12 MiB)
retcode: Failure
u: 2-element Vector{Float64}:
 0.6420544999002016
 0.40307989437093683
...
```
153.209 μs (1208 allocations: 63.64 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999634355313174
 0.9999315506115275
...
```
90.340 μs (812 allocations: 40.22 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999373614
 0.999999999868622
...
```
202.089 μs (1019 allocations: 70.32 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999994
 0.9999999999999989
...
```
193.298 μs (1184 allocations: 70.84 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.999999999999108
 0.9999999999981819
...
```
782.533 μs (8877 allocations: 394.24 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
947.152 μs (11363 allocations: 529.73 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992669327
 0.9999999985109471
...
```
900.633 μs (10448 allocations: 502.05 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992541948
 0.9999999984843432
...
```
1.061 ms (12010 allocations: 555.07 KiB)
...
```
843.804 μs (9233 allocations: 434.99 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
9.593 ms (89276 allocations: 5.44 MiB)
retcode: Default
u: 2-element Vector{Float64}:
 0.999957450694706
 0.9999163934196296
...
```
764.854 μs (8678 allocations: 446.09 KiB)
retcode: Failure
u: 2-element Vector{Float64}:
 1.000000050297047
 1.0000000872902168
...
```
812.533 μs (2479 allocations: 78.02 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999999
 0.9999999999999998
...
```
1.770 ms (4593 allocations: 178.02 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999894374
 0.9999999999844783
...
```
1.728 ms (4481 allocations: 174.61 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.6400000000000001
...
```
3.481 ms (67429 allocations: 3.20 MiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.8
...
```
11.625 ms (145498 allocations: 8.09 MiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.6577248385974865
 0.43
...
⌃ [7c1d4256] DynamicPolynomials v0.6.3
  [06fc5a27] DynamicQuantities v1.12.3
