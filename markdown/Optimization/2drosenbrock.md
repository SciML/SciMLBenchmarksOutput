...
```
2.073 ms (19062 allocations: 819.39 KiB)
retcode: MaxIters
...
```
1.978 ms (18396 allocations: 896.71 KiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.731208899696419
 0.5317564806282805
...
```
138.679 μs (1106 allocations: 55.67 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999634355313174
 0.9999315506115275
...
```
91.350 μs (823 allocations: 46.36 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000000000681024
 1.0000000001353884
...
```
212.579 μs (1089 allocations: 78.56 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999969390242
 0.9999999938464837
...
```
191.079 μs (1069 allocations: 69.41 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.999999999999108
 0.9999999999981819
...
```
1.057 ms (9755 allocations: 439.17 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
1.216 ms (12243 allocations: 574.77 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992669327
 0.9999999985109471
...
```
1.166 ms (11326 allocations: 547.06 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992541948
 0.9999999984843432
...
```
1.846 ms (17364 allocations: 792.73 KiB)
  1.068 ms (10930 allocations: 508.06 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.24327905408863862
 0.05757865786675858
...
```
1.100 ms (10024 allocations: 477.80 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
9.191 ms (89282 allocations: 5.44 MiB)
retcode: Default
u: 2-element Vector{Float64}:
 0.999957450694706
 0.9999163934196296
...
```
714.076 μs (8478 allocations: 443.32 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000001653009143
 1.0000003027695628
...
```
826.555 μs (2485 allocations: 78.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999999
 0.9999999999999998
...
```
1.166 ms (3420 allocations: 132.75 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999894374
 0.9999999999844783
...
```
1.084 ms (3224 allocations: 125.42 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.6400000000000001
...
```
4.189 ms (70182 allocations: 3.33 MiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.8
...
```
11.533 ms (145500 allocations: 8.10 MiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.6577248383891864
 0.43
...
```
Status `~/github-runners/amdci3-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Optimization/Project.toml`
  [6e4b80f9] BenchmarkTools v1.8.0
  [f6369f11] ForwardDiff v1.4.5
  [961ee093] ModelingToolkit v11.42.1
  [7f7a1694] Optimization v5.9.0
  [3e6eede4] OptimizationBBO v0.4.12
  [bd407f91] OptimizationCMAEvolutionStrategy v0.3.13
  [cb963754] OptimizationEvolutionary v0.4.14
...
```
Status `~/github-runners/amdci3-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Optimization/Manifest.toml`
