...
```
1.539 ms (19059 allocations: 817.86 KiB)
retcode: MaxIters
...
```
1.488 ms (18396 allocations: 895.48 KiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.7391828188927565
 0.546501561390091
...
```
101.649 μs (1106 allocations: 53.80 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999634355313174
 0.9999315506115275
...
```
67.329 μs (823 allocations: 44.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000000000681024
 1.0000000001353884
...
```
156.768 μs (1041 allocations: 72.96 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999969390242
 0.9999999938464837
...
```
139.779 μs (1021 allocations: 64.52 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.999999999999108
 0.9999999999981819
...
```
777.673 μs (9707 allocations: 430.95 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
910.362 μs (12195 allocations: 566.54 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992669327
 0.9999999985109471
...
```
884.251 μs (11278 allocations: 538.76 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992541948
 0.9999999984843432
...
```
1.365 ms (17316 allocations: 783.57 KiB)
  797.162 μs (10882 allocations: 500.15 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.24327905408863862
 0.05757865786675858
...
```
820.793 μs (9976 allocations: 469.57 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
7.581 ms (89282 allocations: 5.44 MiB)
retcode: Default
u: 2-element Vector{Float64}:
 0.999957450694706
 0.9999163934196296
...
```
554.525 μs (8115 allocations: 418.16 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999998196328095
 0.9999996410470577
...
```
603.554 μs (2485 allocations: 78.31 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999999
 0.9999999999999998
...
```
1.445 ms (5109 allocations: 186.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999894374
 0.9999999999844783
...
```
1.385 ms (4913 allocations: 179.55 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.6400000000000001
...
```
2.714 ms (71556 allocations: 3.40 MiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.8
...
```
8.779 ms (145400 allocations: 8.09 MiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.6577248384947753
 0.43
