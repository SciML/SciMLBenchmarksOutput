...
```
1.931 ms (19059 allocations: 817.86 KiB)
retcode: MaxIters
...
```
1.987 ms (18396 allocations: 895.48 KiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.7745771163469926
 0.6028391220205219
...
```
125.479 μs (1106 allocations: 53.80 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999634355313174
 0.9999315506115275
...
```
81.489 μs (823 allocations: 44.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000000000681024
 1.0000000001353884
...
```
184.008 μs (1041 allocations: 72.96 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999969390242
 0.9999999938464837
...
```
157.599 μs (1021 allocations: 64.52 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.999999999999108
 0.9999999999981819
...
```
919.221 μs (9707 allocations: 430.95 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
1.045 ms (12195 allocations: 566.54 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992669327
 0.9999999985109471
...
```
1.023 ms (11278 allocations: 538.76 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992541948
 0.9999999984843432
...
```
1.729 ms (17316 allocations: 783.57 KiB)
  951.111 μs (10882 allocations: 500.15 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.24327905408863862
 0.05757865786675858
...
```
988.141 μs (9976 allocations: 469.57 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
8.928 ms (89282 allocations: 5.44 MiB)
retcode: Default
u: 2-element Vector{Float64}:
 0.999957450694706
 0.9999163934196296
...
```
661.303 μs (8200 allocations: 422.68 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000004233740893
 1.0000008683015602
...
```
964.341 μs (2485 allocations: 78.31 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999999
 0.9999999999999998
...
```
2.158 ms (5109 allocations: 186.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999894374
 0.9999999999844783
...
```
2.839 ms (4913 allocations: 179.55 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.6400000000000001
...
```
2.814 ms (67437 allocations: 3.20 MiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.8
...
```
10.635 ms (145482 allocations: 8.10 MiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.6577248385055136
 0.43
