...
```
1.524 ms (19053 allocations: 817.77 KiB)
retcode: MaxIters
...
```
1.476 ms (18396 allocations: 895.48 KiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.7683580804080992
 0.5860564064334073
...
```
103.369 μs (1106 allocations: 53.80 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999634355313174
 0.9999315506115275
...
```
68.440 μs (823 allocations: 44.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000000000681024
 1.0000000001353884
...
```
148.258 μs (1041 allocations: 72.96 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999969390242
 0.9999999938464837
...
```
137.918 μs (1021 allocations: 64.52 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.999999999999108
 0.9999999999981819
...
```
789.891 μs (9707 allocations: 430.95 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
912.350 μs (12195 allocations: 566.54 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992669327
 0.9999999985109471
...
```
906.390 μs (11278 allocations: 538.76 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992541948
 0.9999999984843432
...
```
1.405 ms (17316 allocations: 783.57 KiB)
  806.081 μs (10882 allocations: 500.15 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.24327905408863862
 0.05757865786675858
...
```
825.441 μs (9976 allocations: 469.57 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999992619217
 0.9999999985003628
...
```
7.108 ms (89282 allocations: 5.44 MiB)
retcode: Default
u: 2-element Vector{Float64}:
 0.999957450694706
 0.9999163934196296
...
```
520.545 μs (7942 allocations: 410.21 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 1.0000001902408124
 1.0000003976530663
...
```
619.443 μs (2485 allocations: 78.31 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999999999
 0.9999999999999998
...
```
1.521 ms (5109 allocations: 186.89 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.9999999999894374
 0.9999999999844783
...
```
1.485 ms (4913 allocations: 179.55 KiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.6400000000000001
...
```
2.608 ms (71556 allocations: 3.40 MiB)
retcode: Success
u: 2-element Vector{Float64}:
 0.8
 0.8
...
```
8.804 ms (145453 allocations: 8.10 MiB)
retcode: MaxIters
u: 2-element Vector{Float64}:
 0.657724838525965
 0.43
...
SciMLBenchmarks.weave_file("benchmarks/Optimization","2drosenbrock.jmd")
```
...
```
Status `~/github-runners/amdci8-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Optimization/Project.toml`
  [6e4b80f9] BenchmarkTools v1.8.0
  [f6369f11] ForwardDiff v1.4.5
⌅ [961ee093] ModelingToolkit v9.84.0
⌃ [7f7a1694] Optimization v5.7.0
⌃ [3e6eede4] OptimizationBBO v0.4.11
⌃ [bd407f91] OptimizationCMAEvolutionStrategy v0.3.12
⌃ [cb963754] OptimizationEvolutionary v0.4.13
⌃ [4e6fcdb7] OptimizationNLopt v0.3.15
⌃ [36348300] OptimizationOptimJL v0.4.18
⌃ [42dfb2eb] OptimizationOptimisers v0.3.21
...
```
Status `~/github-runners/amdci8-1/_work/SciMLBenchmarks.jl/SciMLBenchmarks.jl/benchmarks/Optimization/Manifest.toml`
...
⌃ [70df07ce] BracketingNonlinearSolve v1.12.1
  ...
  [8d3b24bd] CMAEvolutionStrategy v0.2.6
...
⌅ [682c06a0] JSON v0.21.4
  ...
  [98e50ef6] JuliaFormatter v2.14.0
