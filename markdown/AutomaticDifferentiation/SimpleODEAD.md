...
```
5.169519 seconds (9.95 M allocations: 682.489 MiB, 5.80% gc time, 92.59% 
compilation time)
 16.592885 seconds (19.95 M allocations: 1.478 GiB, 6.78% gc time, 85.24% c
ompilation time)
 82.986104 seconds (5.97 M allocations: 769.701 MiB, 0.79% gc time, 6.70% c
ompilation time)
 95.106869 seconds (7.54 M allocations: 1.030 GiB, 2.85% gc time, 5.43% com
pilation time)
 58.951563 seconds (4.24 M allocations: 816.819 MiB, 2.44% gc time, 5.08% c
ompilation time)
...
─────┼─────────────────────────────────────────────────────────────────────
─────
   1 │ Compile-time CSA           7.595e-5     61.5496    0.0         0.0  
    ⋯
   2 │ DSA                        3.762e-5      1.80456   0.00775379  0.001
662
   3 │ CSA user-Jacobian          0.000302378  91.2157    0.45285     0.006
567
   4 │ AD-Jacobian                0.000436867  74.6991    0.492134    0.005
215
   5 │ AD-Jv seeding              0.000254548  79.9519    0.425742    0.006
985 ⋯
   6 │ Numerical Differentiation  0.000187178   0.345507  0.00623976  0.006
704
                                                                1 column om
itted
```
...
```
2.709620 seconds (6.04 M allocations: 403.478 MiB, 4.06% gc time, 99.94% 
compilation time)
  4.191747 seconds (6.94 M allocations: 469.080 MiB, 4.43% gc time, 99.82% 
compilation time)
 55.131758 seconds (82.76 M allocations: 5.498 GiB, 3.54% gc time, 99.89% c
ompilation time: <1% of which was recompilation)
  0.507198 seconds (612.97 k allocations: 41.705 MiB, 99.45% compilation ti
me)
...
```
16.480887 seconds (17.92 M allocations: 1.373 GiB, 3.49% gc time, 88.81% c
ompilation time)
 77.862878 seconds (69.18 M allocations: 4.416 GiB, 1.89% gc time, 88.51% c
ompilation time)
  3.474514 seconds (2.77 M allocations: 226.813 MiB, 2.44% gc time, 73.11% 
compilation time)
12-element Vector{Float64}:
   1.755969538
 NaN
...
```
15.856625 seconds (17.83 M allocations: 1.109 GiB, 3.51% gc time, 99.95% c
ompilation time)
 64.663651 seconds (68.91 M allocations: 3.899 GiB, 1.86% gc time, 91.20% c
ompilation time)
  2.368434 seconds (2.57 M allocations: 156.905 MiB, 99.30% compilation tim
e)
12-element Vector{Float64}:
   0.005109706
 NaN
...
```
3.072841 seconds (5.73 M allocations: 385.729 MiB, 2.86% gc time, 99.85% 
compilation time)
  3.090057 seconds (5.59 M allocations: 311.318 MiB, 1.65% gc time, 95.52% 
compilation time)
 27.829234 seconds (41.86 M allocations: 2.741 GiB, 3.54% gc time, 99.77% c
ompilation time)
  0.236863 seconds (440.42 k allocations: 33.698 MiB, 92.13% compilation ti
me)
12-element Vector{Float64}:
   0.002312095
   0.130924463
...
| -----------------------------:| -----------:| ---------:| -------------:| ----------:|
|                   ForwardDiff | 0.000101459 |   1.75597 |    0.00510971 |  0.0023121 |
|                   ReverseDiff |  0.00440955 |       NaN |           NaN |   0.130924 |
| InterpolatingAdjoint User Jac | 0.000465577 |   3.53562 |      0.856189 | 0.00660233 |
|   InterpolatingAdjoint AD Jac | 0.000564186 |   1.41862 |        1.2579 | 0.00508091 |
|      InterpolatingAdjoint v'J | 0.000326907 | 0.0985249 |      0.204607 | 0.00173203 |
|    QuadratureAdjoint User Jac |  0.00110875 |  0.173306 |      0.196223 | 0.00628649 |
|      QuadratureAdjoint AD Jac |  0.00121927 |  0.253057 |      0.607025 | 0.00581369 |
|         QuadratureAdjoint v'J |  0.00177332 | 0.0624669 |      0.357753 | 0.00605383 |
|     BacksolveAdjoint User Jac | 0.000809124 |       NaN |           NaN |        NaN |
|       BacksolveAdjoint AD Jac | 0.000971443 |       NaN |           NaN |        NaN |
|          BacksolveAdjoint v'J | 0.000497686 |       NaN |           NaN |        NaN |
|     Numerical Differentiation | 0.000626666 |  0.931139 |     0.0149094 |  0.0158726 |
