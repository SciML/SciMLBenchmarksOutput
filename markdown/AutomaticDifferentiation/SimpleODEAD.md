...
```
5.247434 seconds (10.07 M allocations: 691.449 MiB, 5.12% gc time, 92.53%
 compilation time)
 16.081537 seconds (19.11 M allocations: 1.436 GiB, 3.75% gc time, 87.49% c
ompilation time)
 82.989841 seconds (6.19 M allocations: 783.298 MiB, 0.18% gc time, 6.23% c
ompilation time)
 93.905486 seconds (7.31 M allocations: 1.015 GiB, 3.04% gc time, 5.44% com
pilation time)
 53.984026 seconds (4.23 M allocations: 816.423 MiB, 2.44% gc time, 4.47% c
ompilation time)
...
─────┼─────────────────────────────────────────────────────────────────────
─────
   1 │ Compile-time CSA           7.4959e-5    49.7555    0.0         0.0  
    ⋯
   2 │ DSA                        3.7629e-5     1.74187   0.00769864  0.001
720
   3 │ CSA user-Jacobian          0.000309087  79.3821    0.349101    0.006
474
   4 │ AD-Jacobian                0.000421506  62.875     0.401261    0.005
200
   5 │ AD-Jv seeding              0.000282258  75.494     0.453304    0.007
653 ⋯
   6 │ Numerical Differentiation  0.000183149   0.342078  0.00634394  0.006
583
                                                                1 column om
itted
```
...
```
2.780092 seconds (5.93 M allocations: 400.544 MiB, 6.19% gc time, 99.94% 
compilation time)
  3.878264 seconds (6.82 M allocations: 465.686 MiB, 2.47% gc time, 99.82% 
compilation time)
 53.323955 seconds (82.35 M allocations: 5.491 GiB, 5.46% gc time, 99.90% c
ompilation time: <1% of which was recompilation)
  0.475941 seconds (610.42 k allocations: 41.566 MiB, 99.58% compilation ti
me)
...
```
15.297238 seconds (17.91 M allocations: 1.374 GiB, 3.08% gc time, 87.65% c
ompilation time)
 73.993462 seconds (68.99 M allocations: 4.410 GiB, 1.64% gc time, 87.76% c
ompilation time)
  3.289909 seconds (2.75 M allocations: 226.287 MiB, 1.84% gc time, 71.65% 
compilation time)
12-element Vector{Float64}:
   1.760397445
 NaN
...
```
14.793684 seconds (17.82 M allocations: 1.109 GiB, 2.89% gc time, 99.46% c
ompilation time)
 60.511115 seconds (68.83 M allocations: 3.901 GiB, 1.71% gc time, 91.17% c
ompilation time)
  2.291661 seconds (2.55 M allocations: 156.414 MiB, 2.56% gc time, 99.32% 
compilation time)
12-element Vector{Float64}:
   0.00503949
 NaN
...
```
2.907050 seconds (5.69 M allocations: 384.916 MiB, 4.09% gc time, 99.85% 
compilation time)
  2.989343 seconds (5.58 M allocations: 310.873 MiB, 4.21% gc time, 93.21% 
compilation time)
 26.103439 seconds (41.71 M allocations: 2.737 GiB, 2.93% gc time, 99.78% c
ompilation time)
  0.265413 seconds (439.15 k allocations: 33.597 MiB, 14.68% gc time, 78.59
% compilation time)
12-element Vector{Float64}:
   0.002629799
   0.118286721
...
| -----------------------------:| -----------:| ---------:| -------------:| ----------:|
|                   ForwardDiff |   9.7109e-5 |    1.7604 |    0.00503949 |  0.0026298 |
|                   ReverseDiff |   0.0042267 |       NaN |           NaN |   0.118287 |
| InterpolatingAdjoint User Jac | 0.000444256 |   2.89044 |      0.903436 | 0.00654546 |
|   InterpolatingAdjoint AD Jac | 0.000541086 |   1.45311 |       1.31292 | 0.00506819 |
|      InterpolatingAdjoint v'J | 0.000320927 | 0.0988763 |       0.19235 | 0.00170689 |
|    QuadratureAdjoint User Jac |   0.0010775 |  0.170921 |      0.193026 | 0.00622973 |
|      QuadratureAdjoint AD Jac |  0.00120058 |  0.252714 |      0.570649 | 0.00575928 |
|         QuadratureAdjoint v'J |   0.0017081 | 0.0551092 |      0.370939 | 0.00584619 |
|     BacksolveAdjoint User Jac | 0.000755704 |       NaN |           NaN |        NaN |
|       BacksolveAdjoint AD Jac | 0.000931023 |       NaN |           NaN |        NaN |
|          BacksolveAdjoint v'J | 0.000504276 |       NaN |           NaN |        NaN |
|     Numerical Differentiation | 0.000606626 |  0.934989 |     0.0146514 |   0.015663 |
