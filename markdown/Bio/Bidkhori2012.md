...
────
                             ...
                             ───────────────────────   ────────────────────
────
      Tot / % measured:           16.0s /  96.6%           1.76GiB /  97.8%
 ...
 ──────────────────────────────────────────────────────────────────────────
────
 ODEProb DenseJac         1    9.92s   64.0%   9.92s   1.13GiB   65.6%  1.1
3GiB
 ODEProb No Jac           1    3.68s   23.7%   3.68s    399MiB   22.6%   39
9MiB
 ODEProb SparseJac        1    1.91s   12.3%   1.91s    207MiB   11.7%   20
7MiB
 ──────────────────────────────────────────────────────────────────────────
────
```
...
```
numspecies(sys) = 109
numreactions(sys) = 109
length(parameters(sys)) = 188
188
```
...
```
0.130961 seconds (175.42 k allocations: 12.809 MiB, 83.79% compilation ti
me)
retcode: Success
