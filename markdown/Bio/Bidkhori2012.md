...
───
                            ...
                            ───────────────────────   ─────────────────────
───
     Tot / % measured:           10.6s /  94.2%           1.52GiB /  98.1% 
...
───────────────────────────────────────────────────────────────────────────
───
ODEProb No Jac           1    3.95s   39.6%   3.95s    571MiB   37.3%   571
MiB
ODEProb DenseJac         1    3.49s   34.9%   3.49s    645MiB   42.2%   645
MiB
ODEProb SparseJac        1    2.55s   25.5%   2.55s    313MiB   20.5%   313
MiB
───────────────────────────────────────────────────────────────────────────
───
```
...
```
0.146069 seconds (127.10 k allocations: 11.889 MiB, 86.85% compilation ti
me)
retcode: Success
...
solnames = ["CVODE_BDF", "KenCarp4", "Rodas4", "QNDF",
    "ImplEulerExtpl (threaded)", "ImplEulerExtpl (non-threaded)",
    "ImplEulerBaryExtpl (threaded)", "ImplEulerBaryExtpl (non-threaded)",
    "ImplHWExtpl (threaded)", "ImplHWExtpl (non-threaded)"]
...
setups = [
    ...
    Dict(:alg=>QNDF(autodiff = false))    #Dict(:alg=>lsoda()),
    #Dict(:alg=>radau()),
    #Dict(:alg=>seulex()),
...
solnames = ["KenCarp4", "Rodas4", "QNDF"#"ImplEulerExtpl (threaded)", "ImplEulerExtpl (non-threaded)",    #"ImplEulerBaryExtpl (threaded)","ImplEulerBaryExtpl (non-threaded)","ImplHWExtpl (threaded)","ImplHWExtpl (non-threaded)"
]
