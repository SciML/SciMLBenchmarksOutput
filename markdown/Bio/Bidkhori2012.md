...
────
                             ...
                             ───────────────────────   ────────────────────
────
      Tot / % measured:           8.57s /  94.4%           1.10GiB /  98.1%
 ...
 ──────────────────────────────────────────────────────────────────────────
────
 ODEProb DenseJac         1    5.13s   63.4%   5.13s    813MiB   73.5%   81
3MiB
 ODEProb No Jac           1    2.01s   24.8%   2.01s    151MiB   13.7%   15
1MiB
 ODEProb SparseJac        1    953ms   11.8%   953ms    141MiB   12.8%   14
1MiB
 ──────────────────────────────────────────────────────────────────────────
────
```
...
```
Error: MethodError: no method matching get_species(::ModelingToolkit.ODESys
tem)

Closest candidates are:
  get_species(!Matched::Catalyst.ReactionSystem)
   @ Catalyst /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae0a-
f4d2d937f953/packages/Catalyst/zTvWJ/src/reactionsystem.jl:743
```
...
```
0.144469 seconds (147.89 k allocations: 12.862 MiB, 85.70% compilation ti
me)
retcode: Success
