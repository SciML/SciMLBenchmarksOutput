...
───
                            ...
                            ───────────────────────   ─────────────────────
───
     Tot / % measured:           12.1s /  94.6%           1.52GiB /  97.5% 
...
───────────────────────────────────────────────────────────────────────────
───
ODEProb No Jac           1    4.44s   38.7%   4.44s    567MiB   37.3%   567
MiB
ODEProb DenseJac         1    4.30s   37.4%   4.30s    643MiB   42.3%   643
MiB
ODEProb SparseJac        1    2.75s   23.9%   2.75s    311MiB   20.5%   311
MiB
───────────────────────────────────────────────────────────────────────────
───
```
...
```
0.185379 seconds (126.64 k allocations: 11.849 MiB, 16.83% gc time, 89.39
% compilation time)
retcode: Success
