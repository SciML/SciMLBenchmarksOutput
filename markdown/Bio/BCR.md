...
────
                             ...
                             ───────────────────────   ────────────────────
────
      Tot / % measured:            514s /  99.5%            209GiB /  99.8%
 ...
 ──────────────────────────────────────────────────────────────────────────
────
 ODEProb SparseJac        1     447s   87.4%    447s    195GiB   93.5%   19
5GiB
 ODEProb No Jac           1    35.6s    7.0%   35.6s   7.35GiB    3.5%  7.3
5GiB
 Create ODESys            1    15.0s    2.9%   15.0s   3.72GiB    1.8%  3.7
2GiB
 Parse Network            1    13.8s    2.7%   13.8s   2.44GiB    1.2%  2.4
4GiB
 ──────────────────────────────────────────────────────────────────────────
────
```
...
```
39.300 μs (11 allocations: 1.12 KiB)
```
...
────
                             ...
                             ───────────────────────   ────────────────────
────
      Tot / % measured:            608s /  97.2%            219GiB /  99.7%
 ...
 ──────────────────────────────────────────────────────────────────────────
────
 ODEProb SparseJac        1     447s   75.7%    447s    195GiB   89.5%   19
5GiB
 SparseJac Eval1          1    49.6s    8.4%   49.6s   5.41GiB    2.5%  5.4
1GiB
 ODEProb No Jac           1    35.6s    6.0%   35.6s   7.35GiB    3.4%  7.3
5GiB
 ODE rhs Eval1            1    29.6s    5.0%   29.6s   4.04GiB    1.9%  4.0
4GiB
 Create ODESys            1    15.0s    2.5%   15.0s   3.72GiB    1.7%  3.7
2GiB
 Parse Network            1    13.8s    2.3%   13.8s   2.44GiB    1.1%  2.4
4GiB
 SparseJac Eval2          1    697μs    0.0%   697μs   11.9KiB    0.0%  11.
9KiB
 ODE rhs Eval2            1    238μs    0.0%   238μs   1.30KiB    0.0%  1.3
0KiB
 ──────────────────────────────────────────────────────────────────────────
────
```
...
```
648.116680 seconds (5.04 M allocations: 2.132 GiB, 0.25% gc time, 0.14% com
pilation time)
retcode: Success
