...
────
                             ...
                             ───────────────────────   ────────────────────
────
      Tot / % measured:           2.17h / 100.0%           10.4TiB / 100.0%
 ...
 ──────────────────────────────────────────────────────────────────────────
────
 ODEProb SparseJac        1    2.14h   99.0%   2.14h   10.4TiB   99.8%  10.
4TiB
 ODEProb No Jac           1    40.8s    0.5%   40.8s   8.86GiB    0.1%  8.8
6GiB
 Create ODESys            1    20.2s    0.3%   20.2s   7.95GiB    0.1%  7.9
5GiB
 Parse Network            1    16.3s    0.2%   16.3s   3.82GiB    0.0%  3.8
2GiB
 ──────────────────────────────────────────────────────────────────────────
────
```
...
```
76.389 μs (3 allocations: 576 bytes)
```
...
```
2145.448227 seconds (1.84 M allocations: 409.369 MiB, 0.04% compilation tim
e)
retcode: Success
