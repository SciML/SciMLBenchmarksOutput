...
```
Error: MethodError: no method matching DiffEqJump.JumpProblem(::Catalyst.Re
actionSystem{Nothing, Catalyst.NetworkProperties{Int64, SymbolicUtils.Term{
Real, Base.ImmutableDict{DataType, Any}}}}, ::SciMLBase.DiscreteProblem{Vec
tor{Int64}, Tuple{Float64, Float64}, true, Vector{Float64}, SciMLBase.Discr
eteFunction{true, SciMLBase.DiscreteFunction{true, SciMLBase.var"#192#193",
 Nothing, Nothing, typeof(SciMLBase.DEFAULT_OBSERVED)}, Nothing, Vector{Sym
bol}, ModelingToolkit.var"#generated_observed#568"{Bool, ModelingToolkit.Ju
mpSystem{RecursiveArrayTools.ArrayPartition{Any, Tuple{Vector{JumpProcesses
.MassActionJump}, Vector{JumpProcesses.ConstantRateJump}, Vector{JumpProces
ses.VariableRateJump}}}}, Dict{Any, Any}}}, Base.Pairs{Symbol, Union{}, Tup
le{}, NamedTuple{(), Tuple{}}}}, ::DiffEqJump.Direct; save_positions=(false
, false))
Closest candidates are:
  DiffEqJump.JumpProblem(::P, ::A, ::J, !Matched::C, !Matched::J2, !Matched
::J3, !Matched::J4, !Matched::R) where {P, A, J, C, J2, J3, J4, R} at /cach
e/julia-buildkite-plugin/depots/5b300254-1738-4989-ae0a-f4d2d937f953/packag
es/DiffEqJump/o61Dj/src/problem.jl:78 got unsupported keyword argument "sav
e_positions"
  DiffEqJump.JumpProblem(::Any, !Matched::DiffEqJump.VariableRateJump; kwar
gs...) at /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae0a-f4d2
d937f953/packages/DiffEqJump/o61Dj/src/problem.jl:122
  DiffEqJump.JumpProblem(::Any, !Matched::DiffEqJump.AbstractAggregatorAlgo
rithm, !Matched::DiffEqJump.JumpSet; save_positions, rng, scale_rates, usei
szero, spatial_system, hopping_constants, kwargs...) at /cache/julia-buildk
ite-plugin/depots/5b300254-1738-4989-ae0a-f4d2d937f953/packages/DiffEqJump/
o61Dj/src/problem.jl:159
  ...
```
