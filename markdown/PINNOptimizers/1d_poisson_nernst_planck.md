...
function solve(opt)
    ...
    eqs = [
        ...
        (Dt(Na(t, x)) ~
         (1.0 / Pe_Na) * Dxx(Na(t, x))
         +
         z_Na / (abs(z_Na) * M_Na)
         *
         (Dx(Na(t, x)) * Dx(Phi(t, x)) + Na(t, x) * Dxx(Phi(t, x)))),
        (Dt(Cl(t, x)) ~
         (1.0 / Pe_Cl) * Dxx(Cl(t, x))
         +
         z_Cl / (abs(z_Cl) * M_Cl)
         *
...
```
(Any[517.8678055153289, 369.3128849511351, 260.79863099554973, 180.89694096
21778, 120.54350498116561, 75.43403492618975, 45.34069618345593, 31.1697237
95892722, 31.562135808709705, 41.35558707925725  …  0.653286231586117, 0.61
73956120409475, 0.6029810996756829, 0.5758842430671869, 0.5532475085950292,
 0.5437535273923754, 0.5339473600081592, 0.5015757619702388, 0.472718031038
62053, 0.44650033182328913], Any[0.001, 2.814995050430298, 5.72843503952026
4, 8.53378701210022, 11.272104978561401, 13.99312686920166, 16.543709039688
11, 19.316606044769287, 22.065305948257446, 24.71774697303772  …  2194.0291
709899902, 2222.9388978481293, 2232.740988969803, 2242.884953022003, 2256.1
98271036148, 2262.04176402092, 2270.6151509284973, 2283.1127438545227, 2295
.747134923935, 2309.1580040454865])
```
...
![](figures/1d_poisson_nernst_planck_6_1.png)
...
![](figures/1d_poisson_nernst_planck_7_1.png)
...
d], loss_7[end], loss_8[end], loss_9[end]) = (16.8840304763678, 9.871672297
991854, 11.941759688179685, 13.263439223185827, 24.786852630553575, 15.2742
38217739018, 0.17110632844781154, 2.4889247601582976, 0.44650033182328913)
(16.8840304763678, 9.871672297991854, 11.941759688179685, 13.26343922318582
7, 24.786852630553575, 15.274238217739018, 0.17110632844781154, 2.488924760
1582976, 0.44650033182328913)
```
