...
```
15.370123 seconds (10.37 M allocations: 774.879 MiB, 2.15% gc time, 55.56%
 compilation time)
```
...
Tsit5
Vern7
 51.269422 seconds (48.81 M allocations: 3.563 GiB, 2.49% gc time, 85.03% c
ompilation time)
```
...
Vern7
Vern9
  7.653749 seconds (10.25 M allocations: 876.198 MiB, 2.87% gc time, 68.69%
 compilation time)
```
...
Vern9
DP8
  9.735134 seconds (3.53 M allocations: 313.240 MiB, 0.91% gc time, 71.64% 
compilation time)
```
...
CNLF2
SBDF2
 35.730870 seconds (14.16 M allocations: 1.079 GiB, 2.29% gc time, 35.39% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
 69.644110 seconds (26.46 M allocations: 4.742 GiB, 1.33% gc time, 18.56% c
ompilation time)
```
...
CNAB2 (Krylov)
ETDRK2 (Krylov, m=20)
 43.016953 seconds (7.91 M allocations: 2.370 GiB, 0.98% gc time, 7.87% com
pilation time)
```
...
ARKODE4 (GMRES)
ARKODE5 (GMRES)
 22.624441 seconds (11.05 M allocations: 503.738 MiB, 0.87% gc time, 9.63% 
compilation time)
```
...
ETDRK4 (m=20)
HochOst4 (m=20)
284.422624 seconds (51.62 M allocations: 14.513 GiB, 0.65% gc time, 3.74% c
ompilation time)
```
...
ETDRK3 (m=20)
ETDRK4 (m=20)
172.150582 seconds (26.29 M allocations: 8.261 GiB, 0.41% gc time)
```
