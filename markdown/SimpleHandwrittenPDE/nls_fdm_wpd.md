...
```
16.892845 seconds (10.28 M allocations: 767.293 MiB, 3.54% gc time, 53.27%
 compilation time)
```
...
Tsit5
Vern7
 52.400220 seconds (49.16 M allocations: 3.583 GiB, 3.30% gc time, 84.57% c
ompilation time)
```
...
Vern7
Vern9
  7.922571 seconds (10.29 M allocations: 876.352 MiB, 3.87% gc time, 69.66%
 compilation time)
```
...
Vern9
DP8
  9.892122 seconds (3.57 M allocations: 316.108 MiB, 1.19% gc time, 70.35% 
compilation time)
```
...
CNLF2
SBDF2
108.932647 seconds (24.48 M allocations: 1.888 GiB, 1.09% gc time, 17.47% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
 69.929644 seconds (25.84 M allocations: 2.482 GiB, 1.04% gc time, 18.35% c
ompilation time)
```
...
CNAB2 (Krylov)
ETDRK2 (Krylov, m=20)
 59.704876 seconds (7.68 M allocations: 1.814 GiB, 0.51% gc time, 5.69% com
pilation time)
```
...
ARKODE4 (GMRES)
ARKODE5 (GMRES)
 22.600455 seconds (11.09 M allocations: 506.308 MiB, 0.78% gc time, 9.99% 
compilation time)
```
...
ETDRK4 (m=20)
HochOst4 (m=20)
276.917604 seconds (50.39 M allocations: 9.228 GiB, 0.49% gc time, 3.85% co
mpilation time)
```
...
ETDRK3 (m=20)
ETDRK4 (m=20)
163.900205 seconds (24.43 M allocations: 4.680 GiB, 0.26% gc time)
```
