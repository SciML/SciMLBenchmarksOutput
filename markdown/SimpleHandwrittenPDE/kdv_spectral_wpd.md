...
```
15.847667 seconds (12.95 M allocations: 4.483 GiB, 9.68% gc time, 55.80% c
ompilation time)
```
...
CNLF2
SBDF2
593.881600 seconds (33.20 M allocations: 12.560 GiB, 0.63% gc time, 2.91% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
271.113120 seconds (71.57 M allocations: 46.457 GiB, 4.51% gc time, 6.19% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
203.556071 seconds (25.01 M allocations: 20.898 GiB, 3.45% gc time, 1.71% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
181.458880 seconds (110.51 M allocations: 15.657 GiB, 2.89% gc time, 30.94%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 54.501378 seconds (26.07 M allocations: 17.422 GiB, 13.59% gc time, 17.50%
 compilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
 72.203985 seconds (55.92 M allocations: 17.389 GiB, 9.16% gc time, 0.02% c
ompilation time)
```
