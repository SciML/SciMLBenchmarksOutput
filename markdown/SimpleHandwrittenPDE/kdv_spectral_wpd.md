...
```
15.830841 seconds (21.95 M allocations: 2.071 GiB, 6.32% gc time, 69.26% c
ompilation time)
```
...
CNLF2
SBDF2
117.342061 seconds (57.11 M allocations: 25.408 GiB, 2.36% gc time, 8.81% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
318.694182 seconds (102.63 M allocations: 109.101 GiB, 4.41% gc time, 2.73%
 compilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 80.545178 seconds (32.19 M allocations: 26.480 GiB, 5.61% gc time, 2.64% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
534.995510 seconds (116.56 M allocations: 18.526 GiB, 0.49% gc time, 2.20% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
169.308445 seconds (25.42 M allocations: 33.930 GiB, 3.24% gc time, 3.63% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
157.935401 seconds (66.71 M allocations: 30.330 GiB, 2.92% gc time, 0.00% c
ompilation time)
```
