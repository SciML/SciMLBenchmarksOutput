...
```
23.456194 seconds (13.05 M allocations: 4.491 GiB, 6.91% gc time, 60.70% c
ompilation time)
```
...
CNLF2
SBDF2
180.126640 seconds (34.14 M allocations: 15.102 GiB, 2.26% gc time, 11.74% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
382.053499 seconds (72.02 M allocations: 46.485 GiB, 3.10% gc time, 7.07% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
115.778670 seconds (26.86 M allocations: 21.643 GiB, 5.06% gc time, 4.80% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
298.208199 seconds (89.06 M allocations: 12.454 GiB, 1.26% gc time, 32.73% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 96.949997 seconds (25.99 M allocations: 17.416 GiB, 5.85% gc time, 15.65% 
compilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
106.274471 seconds (48.78 M allocations: 16.193 GiB, 5.14% gc time, 0.02% c
ompilation time)
```
