...
```
16.300340 seconds (13.07 M allocations: 4.492 GiB, 13.64% gc time, 52.35% 
compilation time)
```
...
CNLF2
SBDF2
157.974849 seconds (38.10 M allocations: 18.050 GiB, 4.16% gc time, 9.13% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
271.474160 seconds (72.00 M allocations: 46.483 GiB, 6.29% gc time, 6.33% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 94.747551 seconds (28.14 M allocations: 22.623 GiB, 10.29% gc time, 3.72% 
compilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
234.753350 seconds (102.96 M allocations: 15.016 GiB, 2.87% gc time, 23.49%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 54.337450 seconds (25.96 M allocations: 17.414 GiB, 14.78% gc time, 17.85%
 compilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
 74.446632 seconds (55.92 M allocations: 17.389 GiB, 11.38% gc time, 0.01% 
compilation time)
```
