---
author: "Arjit Seth"
title: "Korteweg-De Vries Equation Pseudospectral Methods Work-Precision Diagrams"
---
```julia
...
```
15.906107 seconds (22.15 M allocations: 2.084 GiB, 8.45% gc time, 70.04% c
ompilation time)
```


![](figures/kdv_spectral_wpd_3_1.png)
...
![](figures/kdv_spectral_wpd_4_1.png)
...
![](figures/kdv_spectral_wpd_5_1.png)
...
![](figures/kdv_spectral_wpd_6_1.png)
...
![](figures/kdv_spectral_wpd_7_1.png)
...
![](figures/kdv_spectral_wpd_8_1.png)
...
![](figures/kdv_spectral_wpd_9_1.png)
...
SciMLBenchmarks.weave_file("benchmarks/SimpleHandwrittenPDE","kdv_spectral_wpd.jmd")
```
