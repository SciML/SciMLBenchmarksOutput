...
```
9.414571 seconds (6.91 M allocations: 784.443 MiB, 4.58% gc time, 76.02% 
compilation time)
```
...
CNLF2
SBDF2
169.160068 seconds (26.73 M allocations: 8.152 GiB, 2.85% gc time, 8.29% co
...
ETDRK2 (m=5)
ETDRK2 (m=20)
372.084676 seconds (50.16 M allocations: 25.199 GiB, 2.67% gc time, 4.49% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
118.713949 seconds (15.61 M allocations: 10.381 GiB, 4.38% gc time, 2.78% c
ompilation time)
```
...
ARKODE4
ARKODE5
532.844997 seconds (284.04 M allocations: 45.214 GiB, 4.15% gc time, 7.60% 
compilation time)
```
...
ARKODE4
ARKODE5
433.305337 seconds (306.72 M allocations: 27.325 GiB, 2.07% gc time, 9.19% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 22.232645 seconds (11.15 M allocations: 2.377 GiB, 3.57% gc time, 41.45% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
154.808517 seconds (84.97 M allocations: 16.046 GiB, 3.73% gc time, 0.01% c
ompilation time)
```
