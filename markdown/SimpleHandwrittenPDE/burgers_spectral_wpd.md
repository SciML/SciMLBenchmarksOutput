...
```
5.450237 seconds (5.47 M allocations: 782.900 MiB, 7.84% gc time, 53.65% 
compilation time)
```
...
CNLF2
SBDF2
 94.633756 seconds (35.20 M allocations: 10.335 GiB, 2.00% gc time, 9.95% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
410.699955 seconds (75.58 M allocations: 81.482 GiB, 2.48% gc time, 2.00% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
 98.903696 seconds (16.32 M allocations: 11.597 GiB, 2.09% gc time, 2.00% c
ompilation time)
```
...
ARKODE4
ARKODE5
607.603241 seconds (330.04 M allocations: 55.633 GiB, 0.95% gc time, 1.45% 
compilation time)
```
...
ARKODE4
ARKODE5
660.236413 seconds (326.64 M allocations: 30.150 GiB, 0.50% gc time, 1.29% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
139.455671 seconds (9.97 M allocations: 9.798 GiB, 0.55% gc time, 4.25% com
pilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
195.316847 seconds (89.28 M allocations: 22.062 GiB, 1.34% gc time, 0.00% c
ompilation time)
```
