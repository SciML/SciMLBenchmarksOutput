...
```
9.708871 seconds (6.83 M allocations: 777.760 MiB, 4.03% gc time, 77.50% 
compilation time)
```
...
CNLF2
SBDF2
931.994527 seconds (27.48 M allocations: 7.067 GiB, 0.38% gc time, 1.79% co
...
ETDRK2 (m=5)
ETDRK2 (m=20)
367.771417 seconds (49.88 M allocations: 25.180 GiB, 2.27% gc time, 4.43% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
311.630215 seconds (14.19 M allocations: 10.000 GiB, 1.46% gc time, 1.12% c
ompilation time)
```
...
ARKODE4
ARKODE5
517.517821 seconds (294.99 M allocations: 45.906 GiB, 3.58% gc time, 8.39% 
compilation time)
```
...
ARKODE4
ARKODE5
408.498674 seconds (306.11 M allocations: 26.766 GiB, 1.62% gc time, 9.78% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 23.170800 seconds (11.26 M allocations: 2.383 GiB, 3.46% gc time, 41.62% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
152.078229 seconds (84.97 M allocations: 16.046 GiB, 3.51% gc time, 0.01% c
ompilation time)
```
