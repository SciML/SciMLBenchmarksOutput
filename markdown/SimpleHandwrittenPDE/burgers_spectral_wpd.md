...
```
14.620604 seconds (6.91 M allocations: 784.714 MiB, 3.95% gc time, 76.81% 
compilation time)
```
...
CNLF2
SBDF2
229.183661 seconds (26.24 M allocations: 7.896 GiB, 1.63% gc time, 9.22% co
mpilation time: <1% of which was recompilation)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
492.577395 seconds (46.97 M allocations: 23.114 GiB, 1.49% gc time, 5.19% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
169.270907 seconds (15.61 M allocations: 10.381 GiB, 2.30% gc time, 3.45% c
ompilation time)
```
...
ARKODE4
ARKODE5
700.014616 seconds (284.05 M allocations: 45.214 GiB, 2.32% gc time, 9.06% 
compilation time)
```
...
ARKODE4
ARKODE5
576.482924 seconds (295.86 M allocations: 26.349 GiB, 1.48% gc time, 12.29%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
117.072620 seconds (11.19 M allocations: 2.379 GiB, 0.77% gc time, 11.65% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
247.382852 seconds (84.97 M allocations: 16.046 GiB, 1.50% gc time, 0.01% c
ompilation time)
```
