...
```
8.113695 seconds (6.08 M allocations: 481.439 MiB, 3.38% gc time, 87.57% 
compilation time)
```
...
CNLF2
SBDF2
901.290630 seconds (23.88 M allocations: 3.419 GiB, 0.26% gc time, 1.88% co
...
ETDRK2 (m=5)
ETDRK2 (m=20)
321.538125 seconds (38.32 M allocations: 13.478 GiB, 1.12% gc time, 4.99% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
283.279218 seconds (9.93 M allocations: 6.005 GiB, 1.03% gc time, 1.18% com
pilation time)
```
...
KenCarp4
KenCarp5
 54.285220 seconds (32.56 M allocations: 2.131 GiB, 2.29% gc time, 76.26% c
ompilation time)
```
...
ARKODE4
ARKODE5
 98.753328 seconds (63.88 M allocations: 3.626 GiB, 1.73% gc time, 40.44% c
ompilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 20.181402 seconds (10.73 M allocations: 1.855 GiB, 2.29% gc time, 45.33% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 10.049535 seconds (3.77 M allocations: 893.827 MiB, 2.06% gc time, 0.12% c
ompilation time)
```
