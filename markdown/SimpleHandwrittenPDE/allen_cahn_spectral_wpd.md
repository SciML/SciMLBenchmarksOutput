...
```
4.152498 seconds (4.84 M allocations: 458.736 MiB, 4.44% gc time, 68.00% 
compilation time)
```
...
CNLF2
SBDF2
 83.376692 seconds (27.91 M allocations: 5.615 GiB, 1.94% gc time, 11.28% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
363.573243 seconds (63.52 M allocations: 69.233 GiB, 2.02% gc time, 2.25% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
 78.713171 seconds (9.69 M allocations: 5.794 GiB, 1.30% gc time, 2.77% com
pilation time)
```
...
KenCarp4
KenCarp5
1410.463388 seconds (150.05 M allocations: 5.989 GiB, 0.08% gc time, 0.53% 
compilation time)
```
...
ARKODE4
ARKODE5
1206.813428 seconds (105.63 M allocations: 4.526 GiB, 0.06% gc time, 0.71% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
152.864152 seconds (10.04 M allocations: 14.995 GiB, 0.58% gc time, 3.92% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 93.127868 seconds (4.23 M allocations: 7.898 GiB, 0.24% gc time, 0.01% com
pilation time)
```
