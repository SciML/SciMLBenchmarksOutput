...
```
4.021836 seconds (4.86 M allocations: 459.673 MiB, 4.60% gc time, 68.72% 
compilation time)
```
...
CNLF2
SBDF2
 81.574801 seconds (27.98 M allocations: 5.620 GiB, 2.09% gc time, 12.21% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
361.243222 seconds (63.53 M allocations: 69.234 GiB, 2.02% gc time, 2.23% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (m=5)
 87.949016 seconds (10.19 M allocations: 6.608 GiB, 1.38% gc time, 2.18% co
mpilation time)
```
...
KenCarp4
KenCarp5
1453.058910 seconds (150.02 M allocations: 5.986 GiB, 0.08% gc time, 0.50% 
compilation time)
```
...
ARKODE4
ARKODE5
1226.765475 seconds (105.75 M allocations: 4.529 GiB, 0.07% gc time, 0.69% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
132.422646 seconds (9.81 M allocations: 10.230 GiB, 0.48% gc time, 4.42% co
mpilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 75.095199 seconds (4.13 M allocations: 5.230 GiB, 0.36% gc time, 0.01% com
pilation time)
```
