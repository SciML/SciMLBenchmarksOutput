...
CNLF2
SBDF2
 88.643195 seconds (63.27 M allocations: 27.685 GiB, 16.97% gc time, 28.48%
 compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
156.447819 seconds (72.77 M allocations: 37.322 GiB, 10.12% gc time, 10.78%
 compilation time)
```
...
FBDF
NordsieckBDF
117.194031 seconds (57.69 M allocations: 26.945 GiB, 6.37% gc time, 44.38% 
compilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 77.603814 seconds (34.73 M allocations: 31.665 GiB, 21.74% gc time, 4.46% 
compilation time)
```
...
ARKODE4
ARKODE5
 38.269608 seconds (23.20 M allocations: 3.595 GiB, 4.77% gc time, 72.45% c
ompilation time)
```
...
ARKODE4
ARKODE5
 51.748809 seconds (35.08 M allocations: 4.996 GiB, 5.29% gc time, 76.03% c
ompilation time)
```
...
KenCarp4 (Identity)
KenCarp5 (Identity)
210.236593 seconds (135.03 M allocations: 23.382 GiB, 4.42% gc time, 73.26%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
133.734453 seconds (9.52 M allocations: 36.759 GiB, 1.55% gc time, 4.95% co
mpilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
 88.159843 seconds (2.08 M allocations: 24.034 GiB, 1.10% gc time)
```
