...
CNLF2
SBDF2
 43.455057 seconds (61.71 M allocations: 27.523 GiB, 6.57% gc time, 27.48% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
155.387164 seconds (83.26 M allocations: 58.346 GiB, 7.04% gc time, 5.61% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 54.467211 seconds (40.17 M allocations: 34.580 GiB, 13.18% gc time, 3.67% 
compilation time)
```
...
ARKODE4
ARKODE5
 55.499891 seconds (43.16 M allocations: 5.245 GiB, 2.37% gc time, 16.67% c
ompilation time)
```
...
ARKODE4
ARKODE5
 82.903222 seconds (37.57 M allocations: 4.642 GiB, 0.70% gc time, 9.94% co
mpilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
128.645719 seconds (11.50 M allocations: 19.661 GiB, 0.75% gc time, 4.77% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
 79.685983 seconds (1.76 M allocations: 12.637 GiB, 0.40% gc time, 0.01% co
mpilation time)
```
