...
title: "Nonlinear Schrödinger Equation Pseudospectral Methods Work-Precision Diagrams"
---
```julia
...
```
376.387194 seconds (9.46 M allocations: 681.203 MiB, 0.07% gc time, 3.44% c
ompilation time)
```


![](figures/nls_spectral_wpd_3_1.png)
...
Vern9
DP8
 93.828602 seconds (22.26 M allocations: 1.605 GiB, 1.07% gc time, 30.15% c
ompilation time)
```


![](figures/nls_spectral_wpd_4_1.png)
...
CNLF2
SBDF2
168.988507 seconds (14.19 M allocations: 1.693 GiB, 0.44% gc time, 10.85% c
ompilation time)
```


![](figures/nls_spectral_wpd_5_1.png)
...
ETDRK2 (m=5)
ETDRK2 (m=20)
243.363836 seconds (18.30 M allocations: 1.748 GiB, 0.29% gc time, 8.68% co
mpilation time)
```


![](figures/nls_spectral_wpd_6_1.png)
...
CNAB2 (Krylov linsolve)
ETDRK2 (Krylov, m=20)
198.485122 seconds (4.31 M allocations: 1.275 GiB, 0.17% gc time, 2.48% com
pilation time)
```


![](figures/nls_spectral_wpd_7_1.png)
...
ARKODE4
ARKODE5
227.479775 seconds (8.38 M allocations: 418.901 MiB, 0.11% gc time, 1.38% c
ompilation time)
```


![](figures/nls_spectral_wpd_8_1.png)
...
ETDRK4 (m=20)
HochOst4 (m=20)
1421.125887 seconds (22.90 M allocations: 7.446 GiB, 0.09% gc time, 1.02% c
ompilation time)
```


![](figures/nls_spectral_wpd_9_1.png)
...
ETDRK3 (m=20)
ETDRK4 (m=20)
930.240875 seconds (5.30 M allocations: 3.618 GiB, 0.05% gc time)
```


![](figures/nls_spectral_wpd_10_1.png)
