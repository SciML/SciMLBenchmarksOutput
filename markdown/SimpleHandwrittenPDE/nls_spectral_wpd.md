...
```
28.464109 seconds (9.33 M allocations: 671.170 MiB, 1.14% gc time, 30.14% 
compilation time)
```
...
Vern9
DP8
 73.837860 seconds (22.54 M allocations: 1.623 GiB, 1.22% gc time, 27.70% c
ompilation time)
```
...
CNLF2
SBDF2
5731.676010 seconds (10.37 G allocations: 156.435 GiB, 3.84% gc time, 1.07%
 compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
217.659243 seconds (17.88 M allocations: 1.774 GiB, 1.31% gc time, 7.06% co
mpilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (Krylov, m=20)
1595.211588 seconds (2.59 G allocations: 39.876 GiB, 3.59% gc time, 0.24% c
ompilation time)
```
...
ARKODE4
ARKODE5
189.421702 seconds (8.66 M allocations: 427.945 MiB, 0.09% gc time, 1.16% c
ompilation time)
```
...
ETDRK4 (m=20)
HochOst4 (m=20)
1144.298857 seconds (22.96 M allocations: 7.450 GiB, 0.10% gc time, 0.89% c
ompilation time)
```
...
ETDRK3 (m=20)
ETDRK4 (m=20)
774.471435 seconds (5.57 M allocations: 3.627 GiB, 0.04% gc time)
```
