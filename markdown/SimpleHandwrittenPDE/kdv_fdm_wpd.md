...
```
14.614856 seconds (10.52 M allocations: 1.099 GiB, 7.16% gc time, 94.51% c
ompilation time)
```
...
CNLF2
SBDF2
128.604589 seconds (63.70 M allocations: 27.688 GiB, 6.30% gc time, 29.02% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
415.327213 seconds (109.41 M allocations: 48.924 GiB, 3.17% gc time, 5.12% 
compilation time)
```
...
CNAB2 (Krylov)
ETDRK2 (caching)
166.564385 seconds (30.23 M allocations: 24.953 GiB, 4.18% gc time, 3.31% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
161.576164 seconds (92.92 M allocations: 14.582 GiB, 2.97% gc time, 44.47% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
568.007083 seconds (17.48 M allocations: 22.385 GiB, 0.60% gc time, 1.92% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
476.072720 seconds (16.22 M allocations: 11.988 GiB, 0.21% gc time, 0.00% c
ompilation time)
```
