...
```
23.999174 seconds (23.07 M allocations: 3.282 GiB, 4.27% gc time, 46.39% c
ompilation time)
```
...
CNLF2
SBDF2
 53.723517 seconds (62.51 M allocations: 27.547 GiB, 5.30% gc time, 23.31% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
264.729889 seconds (152.65 M allocations: 117.692 GiB, 5.89% gc time, 3.39%
 compilation time)
```
...
CNAB2 (Krylov)
ETDRK2 (caching)
 57.809975 seconds (40.56 M allocations: 34.592 GiB, 9.53% gc time, 3.69% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
145.469639 seconds (127.54 M allocations: 20.934 GiB, 1.65% gc time, 6.37% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
143.909896 seconds (25.48 M allocations: 33.905 GiB, 3.62% gc time, 4.39% c
ompilation time)
```
...
ETDRK3 (caching)
ETDRK4 (caching)
 85.663232 seconds (16.82 M allocations: 13.965 GiB, 0.72% gc time, 0.01% c
ompilation time)
```
