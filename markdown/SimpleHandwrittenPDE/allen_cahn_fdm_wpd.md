...
```
13.950007 seconds (23.04 M allocations: 1.535 GiB, 7.60% gc time, 99.98% c
ompilation time)
```
...
CNLF2
SBDF2
 59.285251 seconds (51.09 M allocations: 10.658 GiB, 11.34% gc time, 41.73%
 compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
138.616481 seconds (66.37 M allocations: 23.599 GiB, 4.94% gc time, 11.64% 
compilation time)
```
...
FBDF
NordsieckBDF
105.961139 seconds (52.40 M allocations: 19.962 GiB, 3.15% gc time, 47.23% 
compilation time)
```
...
ETDRK2 (caching)
Tsit5
 59.338335 seconds (32.83 M allocations: 18.994 GiB, 16.37% gc time, 10.27%
 compilation time)
```
...
ARKODE4
ARKODE5
 29.363527 seconds (16.73 M allocations: 1.231 GiB, 1.57% gc time, 93.15% c
ompilation time)
```
...
ARKODE4
ARKODE5
 42.257149 seconds (23.40 M allocations: 1.871 GiB, 3.36% gc time, 94.47% c
ompilation time)
```
...
KenCarp4 (Identity)
KenCarp5 (Identity)
169.323731 seconds (98.08 M allocations: 10.488 GiB, 2.59% gc time, 90.57% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
110.738231 seconds (9.01 M allocations: 35.707 GiB, 1.55% gc time, 5.98% co
mpilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 79.273252 seconds (1.41 M allocations: 23.292 GiB, 2.19% gc time)
```
