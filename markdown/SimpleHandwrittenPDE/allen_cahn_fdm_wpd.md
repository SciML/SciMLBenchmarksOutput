...
```
10.693749 seconds (22.10 M allocations: 1.450 GiB, 8.96% gc time, 99.97% c
ompilation time)
```
...
CNLF2
SBDF2
 29.426694 seconds (45.87 M allocations: 10.283 GiB, 5.88% gc time, 41.67% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
149.091150 seconds (76.53 M allocations: 44.911 GiB, 4.11% gc time, 5.93% c
ompilation time)
```
...
ETDRK2 (caching)
Tsit5
 43.954573 seconds (29.58 M allocations: 13.486 GiB, 6.44% gc time, 8.43% c
ompilation time)
```
...
ARKODE4
ARKODE5
 36.678967 seconds (33.90 M allocations: 2.008 GiB, 1.08% gc time, 24.21% c
ompilation time)
```
...
ARKODE4
ARKODE5
 35.921796 seconds (21.02 M allocations: 1.328 GiB, 0.84% gc time, 22.67% c
ompilation time)
```
...
KenCarp4 (Identity)
KenCarp5 (Identity)
197.507390 seconds (72.50 M allocations: 15.017 GiB, 0.94% gc time, 15.06% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
123.038808 seconds (10.97 M allocations: 18.608 GiB, 0.71% gc time, 4.99% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 82.241342 seconds (1.13 M allocations: 11.853 GiB, 0.36% gc time, 0.01% co
mpilation time)
```
