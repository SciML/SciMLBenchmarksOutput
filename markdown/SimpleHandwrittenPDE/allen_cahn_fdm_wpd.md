...
```
14.428539 seconds (23.03 M allocations: 1.531 GiB, 7.27% gc time, 99.97% c
ompilation time)
```
...
CNLF2
SBDF2
124.541527 seconds (61.88 M allocations: 11.503 GiB, 5.06% gc time, 24.79% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
130.577886 seconds (63.92 M allocations: 21.508 GiB, 4.41% gc time, 12.18% 
compilation time)
```
...
FBDF
NordsieckBDF
124.985572 seconds (56.31 M allocations: 20.232 GiB, 2.63% gc time, 41.27% 
compilation time)
```
...
ETDRK2 (caching)
Tsit5
 68.440774 seconds (27.40 M allocations: 15.747 GiB, 12.65% gc time, 8.55% 
compilation time)
```
...
ARKODE4
ARKODE5
 30.993306 seconds (24.47 M allocations: 1.685 GiB, 2.76% gc time, 93.38% c
ompilation time)
```
...
ARKODE4
ARKODE5
 41.496062 seconds (23.41 M allocations: 1.759 GiB, 2.80% gc time, 95.16% c
ompilation time)
```
...
KenCarp4 (Identity)
KenCarp5 (Identity)
169.995825 seconds (98.20 M allocations: 10.479 GiB, 3.30% gc time, 91.39% 
compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
153.830751 seconds (9.06 M allocations: 35.710 GiB, 1.46% gc time, 4.23% co
mpilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 86.612099 seconds (1.41 M allocations: 23.292 GiB, 1.00% gc time)
```
