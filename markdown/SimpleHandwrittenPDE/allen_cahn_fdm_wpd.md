...
```
10.896959 seconds (22.32 M allocations: 1.465 GiB, 11.49% gc time, 99.98% 
compilation time)
```
...
CNLF2
SBDF2
 29.351556 seconds (45.85 M allocations: 10.281 GiB, 4.64% gc time, 40.05% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
152.276842 seconds (79.70 M allocations: 48.019 GiB, 4.66% gc time, 5.70% c
ompilation time)
```
...
ETDRK2 (caching)
Tsit5
 42.321188 seconds (29.63 M allocations: 13.489 GiB, 7.97% gc time, 8.61% c
ompilation time)
```
...
ARKODE4
ARKODE5
 38.254705 seconds (33.87 M allocations: 2.006 GiB, 2.71% gc time, 23.03% c
ompilation time)
```
...
ARKODE4
ARKODE5
 36.727366 seconds (20.93 M allocations: 1.322 GiB, 0.95% gc time, 21.87% c
ompilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
128.610280 seconds (10.99 M allocations: 18.610 GiB, 0.70% gc time, 4.63% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 78.665774 seconds (1.13 M allocations: 11.853 GiB, 0.34% gc time, 0.01% co
mpilation time)
```
