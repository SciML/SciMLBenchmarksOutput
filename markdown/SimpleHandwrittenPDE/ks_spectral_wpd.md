...
CNLF2
SBDF2
148.539382 seconds (37.83 M allocations: 18.044 GiB, 5.08% gc time, 9.73% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
279.805253 seconds (71.58 M allocations: 46.454 GiB, 6.26% gc time, 6.05% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 96.464511 seconds (28.23 M allocations: 22.822 GiB, 11.10% gc time, 3.68% 
compilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
170.562700 seconds (100.33 M allocations: 12.700 GiB, 3.47% gc time, 47.35%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 19.007975 seconds (11.90 M allocations: 3.166 GiB, 7.57% gc time, 50.72% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 37.535498 seconds (32.72 M allocations: 6.430 GiB, 7.66% gc time, 0.02% co
mpilation time)
```
