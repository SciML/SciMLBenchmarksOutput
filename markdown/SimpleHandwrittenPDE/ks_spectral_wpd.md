...
CNLF2
SBDF2
167.838164 seconds (33.92 M allocations: 15.097 GiB, 3.27% gc time, 12.83% 
compilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
367.661563 seconds (69.99 M allocations: 45.417 GiB, 3.78% gc time, 7.06% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
113.688135 seconds (26.96 M allocations: 21.842 GiB, 5.91% gc time, 4.94% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
255.172569 seconds (100.35 M allocations: 12.701 GiB, 2.18% gc time, 55.56%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 66.976527 seconds (11.93 M allocations: 3.168 GiB, 1.90% gc time, 21.08% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 65.668554 seconds (26.51 M allocations: 5.445 GiB, 2.00% gc time, 0.01% co
mpilation time)
```
