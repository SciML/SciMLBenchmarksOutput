...
CNLF2
SBDF2
108.663432 seconds (56.98 M allocations: 27.202 GiB, 2.48% gc time, 9.24% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
306.829785 seconds (96.87 M allocations: 102.939 GiB, 4.63% gc time, 2.91% 
compilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 72.865567 seconds (32.01 M allocations: 26.474 GiB, 8.65% gc time, 2.87% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
209.104321 seconds (80.05 M allocations: 11.148 GiB, 0.79% gc time, 7.76% c
ompilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
141.056528 seconds (11.27 M allocations: 17.654 GiB, 0.60% gc time, 4.29% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 89.352705 seconds (29.96 M allocations: 16.913 GiB, 1.31% gc time, 0.01% c
ompilation time)
```
