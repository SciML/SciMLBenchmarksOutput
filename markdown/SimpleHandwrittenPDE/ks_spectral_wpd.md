...
CNLF2
SBDF2
593.707358 seconds (33.16 M allocations: 12.558 GiB, 0.58% gc time, 2.82% c
ompilation time)
```
...
ETDRK2 (m=5)
ETDRK2 (m=20)
278.475144 seconds (71.27 M allocations: 46.437 GiB, 5.40% gc time, 5.85% c
ompilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
209.509421 seconds (26.76 M allocations: 22.413 GiB, 2.65% gc time, 1.72% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
160.007881 seconds (111.49 M allocations: 13.197 GiB, 2.09% gc time, 52.05%
 compilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
 17.448335 seconds (12.01 M allocations: 3.173 GiB, 5.41% gc time, 55.72% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
 35.475855 seconds (32.72 M allocations: 6.430 GiB, 3.50% gc time, 0.05% co
mpilation time)
```
