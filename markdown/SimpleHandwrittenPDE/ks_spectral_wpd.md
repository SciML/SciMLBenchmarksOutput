...
function kuramoto_sivashinsky(N, L, alpha)
    ...
    D2 = D1^2 # 2nd derivative operator
    D4 = D1^4 # 4th derivative operator
    x = SBP.grid(D1)
...
CNLF2
SBDF2
108.001784 seconds (57.02 M allocations: 27.205 GiB, 2.07% gc time, 8.74% c
ompilation time)
```


![](figures/ks_spectral_wpd_4_1.png)
...
ETDRK2 (m=5)
ETDRK2 (m=20)
316.390800 seconds (102.67 M allocations: 109.105 GiB, 3.71% gc time, 2.69%
 compilation time)
```
...
CNAB2 (Krylov linsolve)
ETDRK2 (caching)
 76.006225 seconds (32.03 M allocations: 26.476 GiB, 5.20% gc time, 2.67% c
ompilation time)
```
...
ARKODE4 (Krylov)
ARKODE5 (Krylov)
198.918930 seconds (79.87 M allocations: 11.109 GiB, 0.83% gc time, 8.13% c
ompilation time)
```
...
ETDRK4 (caching)
HochOst4 (caching)
162.034101 seconds (11.38 M allocations: 19.682 GiB, 0.54% gc time, 3.77% c
ompilation time)
```
...
ETDRK3 ()
ETDRK4 ()
139.468324 seconds (29.96 M allocations: 16.913 GiB, 0.58% gc time, 0.00% c
ompilation time)
```
...
SciMLBenchmarks.weave_file("benchmarks/SimpleHandwrittenPDE","ks_spectral_wpd.jmd")
```
