...
```
4.412566 seconds (6.12 M allocations: 899.279 MiB, 2.19% gc time, 49.13% 
compilation time)
```
...
```
0.807339 seconds (1.16 M allocations: 150.491 MiB, 12.61% gc time, 57.11%
 compilation time)
```
...
```
0.352785 seconds (607.59 k allocations: 90.384 MiB, 48.52% compilation ti
me)
```
...
```
1.512472 seconds (3.25 M allocations: 214.235 MiB, 93.69% compilation tim
e)
```
...
```
5.031481 seconds (10.20 M allocations: 652.241 MiB, 8.27% gc time, 99.85%
 compilation time)
```
...
```
0.002698 seconds (2.78 k allocations: 700.750 KiB)
```
...
```
0.002785 seconds (2.87 k allocations: 712.156 KiB)
```
...
```
2.904926 seconds (7.57 M allocations: 499.945 MiB, 3.10% gc time, 99.86% 
compilation time)
```
