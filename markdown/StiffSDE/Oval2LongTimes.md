...
```
4.587235 seconds (7.29 M allocations: 501.951 MiB, 4.73% gc time, 99.85% 
compilation time)
```
...
i = 9
i = 10
 66.152880 seconds (35.10 M allocations: 14.077 GiB, 13.91% gc time, 10.28%
 compilation time)
```
...
i = 9
i = 10
  6.282301 seconds (5.24 M allocations: 1.150 GiB, 6.76% gc time, 37.40% co
mpilation time)
```
...
```
2.599835 seconds (3.62 M allocations: 238.427 MiB, 2.45% gc time, 86.73% 
compilation time)
```
...
```
3.254072 seconds (3.37 M allocations: 184.320 MiB, 60.93% compilation tim
e)
```
...
```
1.466403 seconds (959.70 k allocations: 10.458 MiB)
```
...
```
0.182091 seconds (121.85 k allocations: 4.857 MiB)
```
...
```
0.843669 seconds (541.01 k allocations: 6.981 MiB)
```
...
```
0.135220 seconds (95.30 k allocations: 5.177 MiB)
```
...
```
1.425585 seconds (852.84 k allocations: 9.641 MiB, 6.55% gc time)
```
...
```
18.944766 seconds (12.35 M allocations: 151.074 MiB)
```
...
```
1.402649 seconds (946.99 k allocations: 16.503 MiB)
```
...
i = 9
i = 10
 59.278839 seconds (25.83 M allocations: 13.833 GiB, 14.77% gc time)
```
...
i = 9
i = 10
  4.454649 seconds (2.17 M allocations: 1.114 GiB, 13.48% gc time)
```
