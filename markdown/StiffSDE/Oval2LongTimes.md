...
```
0.159076 seconds (541.91 k allocations: 33.545 MiB, 96.79% compilation ti
me)
```
...
i = 9
i = 10
 18.819418 seconds (33.71 M allocations: 2.086 GiB, 4.15% gc time, 99.32% c
ompilation time)
```
...
i = 9
i = 10
  4.068555 seconds (13.99 M allocations: 795.293 MiB, 3.83% gc time, 79.66%
 compilation time)
```
...
```
2.915576 seconds (5.52 M allocations: 278.178 MiB, 1.81% gc time, 91.73% 
compilation time)
```
...
```
6.569638 seconds (4.24 M allocations: 208.312 MiB, 0.34% gc time, 36.06% 
compilation time)
```
...
```
1.304025 seconds (4.77 k allocations: 2.701 MiB)
```
...
```
0.126903 seconds (7.64 k allocations: 3.271 MiB)
```
...
```
3.043499 seconds (4.04 k allocations: 2.556 MiB)
```
...
```
0.089808 seconds (10.16 k allocations: 3.770 MiB)
```
...
```
1.740278 seconds (6.37 k allocations: 3.019 MiB)
```
...
```
23.343892 seconds (391.68 k allocations: 79.450 MiB, 0.17% gc time)
```
...
```
2.080600 seconds (53.43 k allocations: 12.353 MiB)
```
...
i = 9
i = 10
  0.150966 seconds (676.96 k allocations: 39.067 MiB, 31.60% gc time)
```
...
i = 9
i = 10
  1.097375 seconds (8.06 M allocations: 382.204 MiB, 4.84% gc time)
```
