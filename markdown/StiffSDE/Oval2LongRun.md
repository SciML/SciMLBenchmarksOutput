...
```
0.000632 seconds (332 allocations: 247.219 KiB)
```
...
```
Error: BoundsError: attempt to access 1-element Vector{Vector{Float64}} at 
index [2]
```
...
```
Error: UndefVarError: font not defined
```
...
Unrecognized keyword arguments: [:progressbar]
  ...
  0.390368 seconds (390 allocations: 33.156 KiB)
Unrecognized keyword arguments: [:progressbar]

SRI
Unrecognized keyword arguments: [:progressbar]

  0.671670 seconds (570 allocations: 55.203 KiB)
Unrecognized keyword arguments: [:adaptivealg, :progressbar]

SRIW1
Unrecognized keyword arguments: [:adaptivealg, :progressbar]

  0.208939 seconds (419 allocations: 39.047 KiB)
Unrecognized keyword arguments: [:adaptivealg, :progressbar]

SRI Adaptive
Unrecognized keyword arguments: [:adaptivealg, :progressbar]

  0.007049 seconds (755 allocations: 76.719 KiB)
length(sol.t) = 1
Unrecognized keyword arguments: [:adaptivealg, :progressbar]
...
Unrecognized keyword arguments: [:adaptivealg, :progressbar]
  ...
  0.013037 seconds (651 allocations: 70.078 KiB)
length(sol.t) = 6
6
```
