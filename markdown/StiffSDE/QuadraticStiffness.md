...
```
0.000199 seconds (1.94 k allocations: 94.562 KiB)
  0.283765 seconds (535.95 k allocations: 34.812 MiB, 20.08% gc time, 99.89
% compilation time)
  1.849009 seconds (4.33 M allocations: 246.961 MiB, 2.90% gc time, 99.98% 
compilation time)
  1.206888 seconds (2.62 M allocations: 154.093 MiB, 5.34% gc time, 99.97% 
compilation time)
```
...
```
0.000824 seconds (14.60 k allocations: 664.125 KiB)
  0.000513 seconds (10.64 k allocations: 433.438 KiB)
  0.000150 seconds (602 allocations: 30.078 KiB)
  0.000474 seconds (9.13 k allocations: 399.742 KiB)
```
...
```
0.145258 seconds (262.39 k allocations: 15.344 MiB, 97.56% compilation ti
me: 17% of which was recompilation)
  0.145960 seconds (2.10 M allocations: 84.058 MiB, 35.35% gc time)
  0.303111 seconds (378 allocations: 85.573 MiB, 15.57% gc time)
  0.005070 seconds (404 allocations: 6.912 MiB, 67.77% compilation time)
```
