...
2×10 Matrix{Float64}:
 ...
 0.735231  1.46374  0.884487  -0.705483     0.378981  4.83091  0.827111
```
...
```
30.490423 seconds (2.87 M allocations: 179.075 MiB, 0.56% gc time, 6.34% c
ompilation time)
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    sigma1.2    0.4496    0.5898    0.6931    0.8266    1.2439
     ...
     theta_4    0.9409    1.0967    1.1740    1.2496    1.3731
```
...
```
64.642681 seconds (158.62 M allocations: 23.260 GiB, 11.38% gc time, 58.87
% compilation time)
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           δ    0.9594    1.1012    1.1752    1.2481    1.3837
```
...
```
17.544 s (94428393 allocations: 15.23 GiB)
Chains MCMC chain (10000×17×1 Array{Float64, 3}):
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    theta[4]    0.9649    1.1057    1.1786    1.2511    1.3760
        σ[1]    0.3632    0.4480    0.5056    0.5783    0.7654
```
...
```
29.674 s (200713197 allocations: 15.72 GiB)
