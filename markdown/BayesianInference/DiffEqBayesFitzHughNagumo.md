...
.var"###ParameterizedDiffEqFunction#301", Main.var"##WeaveSandBox#292".var"
###ParameterizedTGradFunction#302", Main.var"##WeaveSandBox#292".var"###Par
ameterizedJacobianFunction#303", Nothing, Nothing, ModelingToolkit.ODESyste
...
```
2×10 Matrix{Float64}:
 1.3319    1.10695  1.09848  1.11772  …  -0.755935  -1.95217  -1.73589
 0.983672  1.03376  1.48705  1.0671       1.33371    1.27735   1.06838
```
...
```
35.538635 seconds (3.16 M allocations: 199.237 MiB, 0.40% gc time, 5.43% c
ompilation time)
 60.256024 seconds (9.93 M allocations: 642.685 MiB, 0.91% gc time, 10.87% 
...
4   ⋯
    ...
    sigma1.1    0.3563    0.1086    0.0018   3306.1111   2095.4175    1.001
0   ⋯
    sigma1.2    0.3715    0.1175    0.0032   2065.5084    845.5111    0.999
9   ⋯
     theta_1    0.9340    0.3193    0.0052   3657.3043   3652.6671    1.000
2   ⋯
     theta_2    0.9276    0.2915    0.0045   4165.4112   4367.6312    1.000
2   ⋯
     theta_3    0.0962    0.0466    0.0014   1625.6895    702.5377    0.999
9   ⋯
     theta_4    0.5482    0.0979    0.0022   2070.0401   1947.9762    1.000
1   ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    sigma1.1    0.2098    0.2800    0.3348    0.4075    0.6239
    sigma1.2    0.2096    0.2896    0.3489    0.4283    0.6732
     theta_1    0.2480    0.7198    0.9596    1.1805    1.4487
     theta_2    0.2924    0.7364    0.9532    1.1427    1.4196
     theta_3    0.0294    0.0621    0.0890    0.1212    0.2093
     theta_4    0.3855    0.4770    0.5395    0.6057    0.7640
```
...
```
83.419243 seconds (416.49 M allocations: 45.267 GiB, 15.55% gc time, 40.01
% compilation time)
...
Number of chains  = 1
Samples per chain = 10000
Wall duration     = 67.46 seconds
Compute duration  = 67.46 seconds
...
4   ⋯
    ...
    theta[1]    0.9401    0.3229    0.0065   2509.2026   2863.4681    1.000
2   ⋯
    theta[2]    0.9230    0.2905    0.0052   3145.2480   3682.2194    1.000
2   ⋯
    theta[3]    0.0832    0.0321    0.0007   1945.5539   1282.4308    1.001
4   ⋯
    theta[4]    0.5203    0.0695    0.0014   2467.1148   3192.4255    1.000
6   ⋯
        σ[1]    0.2455    0.0504    0.0011   1656.7056    513.5806    1.000
9   ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    theta[1]    0.2495    0.7225    0.9666    1.1934    1.4520
    theta[2]    0.2898    0.7319    0.9511    1.1359    1.4159
    theta[3]    0.0296    0.0600    0.0798    0.1028    0.1549
    theta[4]    0.3941    0.4737    0.5153    0.5624    0.6681
        σ[1]    0.1676    0.2101    0.2379    0.2730    0.3643
```
