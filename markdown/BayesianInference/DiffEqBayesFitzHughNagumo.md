...
```
2×10 Matrix{Float64}:
 1.45832  1.21294  1.25996   1.16476  …  -1.0189   -1.99681  -2.11919
 1.05718  1.74657  0.952465  1.32729      1.26901   1.21329   1.22616
```
...
```
28.355230 seconds (2.92 M allocations: 181.599 MiB, 0.53% gc time, 6.92% c
ompilation time)
 53.319837 seconds (9.78 M allocations: 631.034 MiB, 1.00% gc time, 12.38% 
...
4   ⋯
    ...
    sigma1.1    0.3621    0.1175    0.0077    113.8372     41.5821    1.009
3   ⋯
    sigma1.2    0.4314    0.1158    0.0033   1264.7702   2548.6858    1.004
6   ⋯
     theta_1    0.9548    0.3160    0.0129    664.5150   2858.2503    1.002
2   ⋯
     theta_2    0.8459    0.2749    0.0054   2568.3076   3260.3040    1.004
8   ⋯
     theta_3    0.1049    0.0441    0.0029    245.2050    419.3487    1.001
7   ⋯
     theta_4    0.6266    0.1120    0.0060    362.9079    722.7483    1.003
4   ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    sigma1.1    0.1959    0.2779    0.3396    0.4199    0.6458
    sigma1.2    0.2654    0.3531    0.4072    0.4930    0.7151
     theta_1    0.2869    0.7301    0.9598    1.2120    1.4658
     theta_2    0.2461    0.6780    0.8683    1.0303    1.3460
     theta_3    0.0345    0.0715    0.1005    0.1317    0.2032
     theta_4    0.4216    0.5465    0.6231    0.7022    0.8522
```
...
```
71.526239 seconds (253.55 M allocations: 34.118 GiB, 13.67% gc time, 53.99
% compilation time)
...
Number of chains  = 1
Samples per chain = 10000
Wall duration     = 51.08 seconds
Compute duration  = 51.08 seconds
...
4   ⋯
           ...
           σ    0.3006    0.0602    0.0024    438.5526    217.1024    1.000
3   ⋯
           a    0.9896    0.3171    0.0095   1300.4053   1044.7598    1.001
3   ⋯
           b    0.8504    0.2860    0.0069   1726.0258   3032.1578    1.000
2   ⋯
        τinv    0.0916    0.0332    0.0012    869.9504    608.8535    1.004
6   ⋯
           l    0.5955    0.0886    0.0029   1053.0165    521.3435    1.002
4   ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.2010    0.2577    0.2939    0.3363    0.4361
           a    0.3108    0.7721    1.0235    1.2470    1.4651
           b    0.2394    0.6599    0.8695    1.0566    1.3524
        τinv    0.0376    0.0673    0.0880    0.1125    0.1674
           l    0.4409    0.5346    0.5914    0.6474    0.8009
```
...
```
62.195714 seconds (269.92 M allocations: 35.331 GiB, 20.87% gc time, 24.45
% compilation time)
Chains MCMC chain (10000×17×1 Array{Float64, 3}):
...
Number of chains  = 1
Samples per chain = 10000
Wall duration     = 58.2 seconds
Compute duration  = 58.2 seconds
...
4   ⋯
    ...
    theta[1]    0.9859    0.3149    0.0049   3950.5294   3696.6576    1.000
1   ⋯
    theta[2]    0.8426    0.2854    0.0046   3864.4384   3351.3337    0.999
9   ⋯
    theta[3]    0.0912    0.0337    0.0006   3454.4695   3919.8120    1.000
2   ⋯
    theta[4]    0.5939    0.0871    0.0014   4163.8675   3641.1118    1.000
1   ⋯
        σ[1]    0.3028    0.0598    0.0009   4517.1838   4377.3210    1.000
0   ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
    ...
    theta[1]    0.2902    0.7745    1.0168    1.2376    1.4654
    theta[2]    0.2455    0.6516    0.8639    1.0516    1.3431
    theta[3]    0.0378    0.0667    0.0877    0.1114    0.1693
    theta[4]    0.4374    0.5357    0.5881    0.6485    0.7793
        σ[1]    0.2134    0.2609    0.2936    0.3343    0.4448
```
