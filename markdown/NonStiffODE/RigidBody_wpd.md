...
```
Error: MethodError: no method matching powi(::NTuple{8, VecElement{Float64}
}, ::Int64)

Closest candidates are:
  powi(::T, !Matched::T2) where {T<:(Union{Tuple{Vararg{VecElement{var"#s5"
}, var"#s1"}} where var"#s1", var"#s5"} where var"#s5"<:Union{Float16, Floa
t32, Float64}), T2<:Union{Int32, UInt32}}
   @ SIMD /cache/julia-buildkite-plugin/depots/5b300254-1738-4989-ae0a-f4d2
d937f953/packages/SIMD/hyXY3/src/LLVM_intrinsics.jl:305
```
