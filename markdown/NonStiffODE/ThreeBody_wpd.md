...
```
sol[1] - sol[end] = [1.842501706761368e-10, 5.474913321311391e-10, 8.932818
378239858e-8, 2.8677876517946288e-8]
sol[end] - prob.u0 = [-1.842501706761368e-10, -5.474913321311391e-10, -8.93
...
```julia
wp = WorkPrecisionSet(probs, abstols, reltols, setups; appxsol = test_sol,
    dense = false, numruns = 100, verbose = false)
plot(wp)
```
