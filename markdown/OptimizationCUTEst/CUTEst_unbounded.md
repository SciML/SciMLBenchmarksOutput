...
```
Available equality-constrained, unbounded problems:
...
Plotted equality-constrained results.
```
...
```
Full results table for inequality-constrained problems:
