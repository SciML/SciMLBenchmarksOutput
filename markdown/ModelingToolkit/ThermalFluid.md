...
```
81.351921 seconds (76.78 M allocations: 5.077 GiB, 20.81% gc time, 75.23% 
compilation time: 20% of which was recompilation)
 23.655829 seconds (6.77 M allocations: 449.243 MiB, 66.91% gc time, 15.22%
 compilation time)
 24.768774 seconds (9.01 M allocations: 607.507 MiB, 63.97% gc time, 16.61%
 compilation time)
 27.485287 seconds (14.34 M allocations: 907.091 MiB, 58.28% gc time, 18.73
% compilation time)
 33.325402 seconds (28.45 M allocations: 1.887 GiB, 48.73% gc time, 23.28% 
compilation time)
 41.005546 seconds (46.98 M allocations: 3.030 GiB, 42.24% gc time, 26.51% 
compilation time)
 49.141174 seconds (70.00 M allocations: 4.782 GiB, 36.28% gc time, 29.40% 
compilation time)
106.172857 seconds (205.80 M allocations: 14.418 GiB, 19.76% gc time, 31.89
% compilation time)
299.781585 seconds (691.40 M allocations: 50.806 GiB, 9.13% gc time, 30.71%
 compilation time)
661.053466 seconds (1.46 G allocations: 92.545 GiB, 5.49% gc time, 38.92% c
ompilation time)
180.215959 seconds (123.98 M allocations: 7.988 GiB, 11.93% gc time, 53.94%
 compilation time)
261.505274 seconds (164.77 M allocations: 10.903 GiB, 9.23% gc time, 58.28%
 compilation time)
366.775949 seconds (209.08 M allocations: 13.929 GiB, 7.45% gc time, 61.73%
 compilation time)
617.896654 seconds (310.92 M allocations: 19.464 GiB, 5.13% gc time, 65.79%
 compilation time)
```
