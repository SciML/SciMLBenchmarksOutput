...
```
81.235815 seconds (75.85 M allocations: 5.034 GiB, 20.94% gc time, 75.08% 
compilation time: 20% of which was recompilation)
 23.787055 seconds (6.77 M allocations: 448.927 MiB, 67.14% gc time, 15.12%
 compilation time)
 24.898119 seconds (9.01 M allocations: 607.075 MiB, 64.32% gc time, 16.52%
 compilation time)
 27.627578 seconds (14.33 M allocations: 906.925 MiB, 58.59% gc time, 18.60
% compilation time)
 33.456984 seconds (28.44 M allocations: 1.887 GiB, 49.08% gc time, 23.17% 
compilation time)
 41.198040 seconds (46.97 M allocations: 3.029 GiB, 42.60% gc time, 26.30% 
compilation time)
 49.355890 seconds (69.99 M allocations: 4.782 GiB, 36.53% gc time, 29.24% 
compilation time)
106.269544 seconds (205.79 M allocations: 14.418 GiB, 19.96% gc time, 31.78
% compilation time)
299.638922 seconds (691.40 M allocations: 50.807 GiB, 9.03% gc time, 30.74%
 compilation time)
658.214348 seconds (1.46 G allocations: 92.544 GiB, 5.53% gc time, 39.22% c
ompilation time)
180.820940 seconds (123.98 M allocations: 7.988 GiB, 11.92% gc time, 53.73%
 compilation time)
263.449362 seconds (164.77 M allocations: 10.903 GiB, 9.20% gc time, 58.07%
 compilation time)
369.140936 seconds (209.08 M allocations: 13.929 GiB, 7.48% gc time, 61.76%
 compilation time)
622.307839 seconds (310.92 M allocations: 19.464 GiB, 5.07% gc time, 65.30%
 compilation time)
```
