...
loc_bounds = Tuple{Float64, Float64}[
    (0, 1), (0, 1), (
        0, 1,
    ), (0, 1),
]
glo_bounds = Tuple{Float64, Float64}[
    (0, 5), (0, 5), (
        0, 5,
    ), (0, 5),
]
...
@btime res1 = solve(optprob, BBO_adaptive_de_rand_1_bin(), maxiters = 4.0e3)
...
opt = Opt(:GN_CRS2_LM, 4)
@btime res1 = solve(optprob, opt, maxiters = 20000, xtol_rel = 1.0e-12)


opt = Opt(:GN_ISRES, 4)
@btime res1 = solve(optprob, opt, maxiters = 50000, xtol_rel = 1.0e-12)
...
opt = Opt(:LN_NELDERMEAD, 4)
@btime res1 = solve(optprob, opt, maxiters = 10000, xtol_rel = 1.0e-9)
