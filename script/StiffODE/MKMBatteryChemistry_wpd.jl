...
ff = begin
        ...
        ODEFunction{true}(ff, jac = jac, tgrad = tgrad, mass_matrix = M, jac_prototype = nothing, sys = SciMLBase.SymbolCache([:x₁, :x₂, :x₃, :x₄, :x₅, :x₆, :x₇, :x₈, :x₉, :x₁₀, :x₁₁, :x₁₂, :x₁₃]))
    end
...
plot(sol, idxs=[8], xscale = :log10, tspan=(1e-12, 1e-5))


plot(sol, idxs=[11], xscale = :log10, tspan=(1e-12, 1e-5))
